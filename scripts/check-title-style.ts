...
const CHECKS: Check[] = [
  ...
  {
    /* 2026-08-07 사장님 지시: 해요체 종결만 금지. "~까/~나" 질문형은 문제 없음 */
    code: 'F',
    name: '해요체 종결',
    test: (t) => /(해요|하세요|해보세요|합니다|입니다|돼요|되세요|드려요|드립니다|있어요|없어요|[가-힣]세요|[가-힣]져요|[가-힣]아요|[가-힣]어요)[!.]?\s*$/.test(t.trim()),
    hint: '타이틀 종결에 해요체·합니다체 금지("알아두세요"·"내려가요") — 질문형("깎일까?"·"나오나")·명사형("조회까지")은 OK',
  },
];
