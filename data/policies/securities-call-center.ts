...
export const securitiesCallCenterPolicy = {
  ...
  heroHook:
    '장중에 주문이 안 나가면 급한데요. 대표번호는 회사마다 하나로 통합돼 있어 찾기는 쉽습니다. 문제는 그 번호로 걸면 안 되는 업무가 따로 있다는 겁니다. 키움증권은 주문접수가 1544-9000 인데 해외주식은 1544-9400 이 따로 있고, 야간에는 나이트데스크 1544-8400 으로 갈립니다. 대표번호로 걸면 그만큼 돌아갑니다. 그럼 내 용건이 어느 번호인지부터 확인하셔야겠죠.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '지점까지 가실 일은 많이 줄었습니다. 계좌개설과 주문, 이체는 앱과 홈페이지로 끝나는 일이 대부분이고, 서류 원본을 내야 하거나 상속·명의 관련 업무일 때만 창구가 필요합니다. 방문하실 거라면 지도에서 회사명으로 검색하시면 가까운 지점부터 나옵니다.',
