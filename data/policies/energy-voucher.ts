...
export const energyVoucherPolicy: PolicyData = {
  ...
  keyFacts: {
    ...
    지원금액1인: {
      value: '1인 세대 295,200원 / 2인 407,500원 / 3인 532,700원 / 4인 이상 701,300원 (2025년도)',
      source: {
        url: 'https://www.energyv.or.kr/info/support_info.do',
        text: '1인 세대 295,200원, 2인 세대 407,500원, 3인 세대 532,700원, 4인 이상 세대 701,300원 (2025년도 총 지원금액)',
        verifiedAt: '2026-05-16',
      },
    },
    소득기준: {
    ...
    신청기간: {
      value: '2025년 6월 9일 ~ 2025년 12월 31일 (2025년도 기준)',
      source: {
        url: 'https://www.energyv.or.kr/info/support_info.do',
...
export const energyVoucherSpokes: SpokeData[] = [
  ...
  },
  {
    ...
    title: '지원 금액 안내',
    content:
      '1인 295,200원 / 2인 407,500원 / 3인 532,700원 / 4인 이상 701,300원 (2025년도 연간 총액).',
  },
  {
    slug: 'how-to-use',
    role: 'how-to-use',
