...
export const loanCallCenterSpokes = [
  ...
  { slug: 'woori-capital-loan', role: 'eligibility', title: '우리금융캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'woori-bank-loan', role: 'eligibility', title: '우리은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'welcome-savings-loan', role: 'eligibility', title: '웰컴저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'tossbank-loan', role: 'eligibility', title: '토스뱅크 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'tongyang-life-loan', role: 'eligibility', title: '동양생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'suhyup-bank-loan', role: 'eligibility', title: 'Sh수협은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'shinhan-savings-loan', role: 'eligibility', title: '신한저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'shinhan-life-loan', role: 'eligibility', title: '신한라이프 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'shinhan-card-loan', role: 'eligibility', title: '신한카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'shinhan-capital-loan', role: 'eligibility', title: '신한캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'shinhan-bank-loan', role: 'eligibility', title: '신한은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'sc-bank-loan', role: 'eligibility', title: 'SC제일은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'sbi-savings-loan', role: 'eligibility', title: 'SBI저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'sangsangin-savings-loan', role: 'eligibility', title: '상상인저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'samsung-life-loan', role: 'eligibility', title: '삼성생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'samsung-fire-loan', role: 'eligibility', title: '삼성화재 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'samsung-card-loan', role: 'eligibility', title: '삼성카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'pepper-savings-loan', role: 'eligibility', title: '페퍼저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'osb-savings-loan', role: 'eligibility', title: 'OSB저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'ok-savings-loan', role: 'eligibility', title: 'OK저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nhuf-loan', role: 'eligibility', title: '주택도시기금 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nh-savings-loan', role: 'eligibility', title: 'NH저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nh-property-loan', role: 'eligibility', title: 'NH농협손해보험 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nh-life-loan', role: 'eligibility', title: 'NH농협생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nh-card-loan', role: 'eligibility', title: 'NH농협카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'nh-bank-loan', role: 'eligibility', title: 'NH농협은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'moa-savings-loan', role: 'eligibility', title: '모아저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'miraeasset-life-loan', role: 'eligibility', title: '미래에셋생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'mirae-capital-loan', role: 'eligibility', title: '미래에셋캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'metlife-loan', role: 'eligibility', title: '메트라이프생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'meritz-fire-loan', role: 'eligibility', title: '메리츠화재 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'meritz-capital-loan', role: 'eligibility', title: '메리츠캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'lotte-insurance-loan', role: 'eligibility', title: '롯데손해보험 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'lotte-card-loan', role: 'eligibility', title: '롯데카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'lotte-capital-loan', role: 'eligibility', title: '롯데캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kyobo-life-loan', role: 'eligibility', title: '교보생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'knbank-loan', role: 'eligibility', title: 'BNK경남은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kjbank-card-loan', role: 'eligibility', title: '광주은행 카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kiwoom-loan', role: 'eligibility', title: '키움증권 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kinfa-loan', role: 'eligibility', title: '서민금융진흥원 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kfcc-loan', role: 'eligibility', title: '새마을금고 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kdb-loan', role: 'eligibility', title: 'KDB산업은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kdb-capital-loan', role: 'eligibility', title: 'KDB캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'kb-insurance-loan', role: 'eligibility', title: 'KB손해보험 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kb-card-loan', role: 'eligibility', title: 'KB국민카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kb-capital-loan', role: 'eligibility', title: 'KB캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'kb-bank-loan', role: 'eligibility', title: 'KB국민은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'jt-savings-loan', role: 'eligibility', title: 'JT친애저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'jeju-bank-loan', role: 'eligibility', title: '제주은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'jbbank-card-loan', role: 'eligibility', title: '전북은행 카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'jb-woori-capital-loan', role: 'eligibility', title: 'JB우리캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'imcap-loan', role: 'eligibility', title: 'iM캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'imbank-loan', role: 'eligibility', title: 'iM뱅크 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'ibk-savings-loan', role: 'eligibility', title: 'IBK저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'hyundai-marine-loan', role: 'eligibility', title: '현대해상 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hyundai-commercial-loan', role: 'eligibility', title: '현대커머셜 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hyundai-card-loan', role: 'eligibility', title: '현대카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hyundai-capital-loan', role: 'eligibility', title: '현대캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'heungkuk-fire-loan', role: 'eligibility', title: '흥국화재 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hanwha-life-loan', role: 'eligibility', title: '한화생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hankook-savings-loan', role: 'eligibility', title: '한국투자저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hankook-capital-loan', role: 'eligibility', title: '한국캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hana-savings-loan', role: 'eligibility', title: '하나저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hana-life-loan', role: 'eligibility', title: '하나생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hana-card-loan', role: 'eligibility', title: '하나카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hana-capital-loan', role: 'eligibility', title: '하나캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'hana-bank-loan', role: 'eligibility', title: '하나은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'goryo-savings-loan', role: 'eligibility', title: '고려저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'fubon-hyundai-loan', role: 'eligibility', title: '푸본현대생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'db-life-loan', role: 'eligibility', title: 'DB생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'db-insurance-loan', role: 'eligibility', title: 'DB손해보험 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'daol-savings-loan', role: 'eligibility', title: '다올저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'chubb-life-loan', role: 'eligibility', title: '처브라이프생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  ...
  { slug: 'bc-card-loan', role: 'eligibility', title: 'BC카드 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'aia-life-loan', role: 'eligibility', title: 'AIA생명 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
  { slug: 'acuon-savings-loan', role: 'eligibility', title: '애큐온저축은행 대출 고객센터 전화번호 및 대출 상담 연결 안내' },
