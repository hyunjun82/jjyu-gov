  ...
  qa: [
    {
      ...
      intro:
        '크게 저소득층 가구와 사회복지시설로 나뉩니다. 기초생활수급자, 차상위계층, 지자체 추천 복지사각지대 가구, 영구임대주택 입주자, 그리고 사회복지시설이 지원 대상입니다.',
    ...
    },
    {
      ...
      intro:
        '노후화된 저효율 조명기기를 고효율 LED 조명기기로 무상 교체해드립니다. 교체 대상은 형광등, 백열전구, 다운라이트 등 LED가 아닌 기존 조명기기이며, 교체 이후 전기요금 절감 효과를 기대할 수 있습니다.',
    ...
    },
    {
      ...
      question: '어떻게 신청하나요?',
      intro:
        '저소득층 가구는 소재지 시·군·구 에너지 담당부서 또는 읍·면·동 주민센터(행정복지센터)에 문의하면 발굴·지원됩니다. 사회복지시설은 시·군·구 에너지 담당부서에 직접 신청합니다. 영구임대주택은 단지 단위로 협약을 체결해야 합니다.',
    ...
    },
    {
      ...
      intro:
        'LED 조명이 이미 설치되어 있거나, 5년 이내 조명 교체 이력이 있는 경우에는 지원받을 수 없습니다. 시설의 경우 준공 후 5년 이내이거나 리모델링·이전 계획이 있으면 제외됩니다.',
    ...
    },
    {
      ...
      intro:
        '영구임대주택은 단지 단위로 협약을 체결한 후 지원받을 수 있습니다. 개별 가구가 아닌 단지 전체가 협약을 체결해야 하므로, 관리사무소 또는 입주자대표회를 통해 먼저 문의하는 것이 좋습니다.',
    ...
    },
    {
      ...
      intro:
        '주소지 읍·면·동 주민센터(행정복지센터)나 한국에너지재단에 문의하면 됩니다. 사회복지시설은 소재지 시·군·구 에너지 담당부서에 직접 연락하세요.',
    ...
    },
    {
      ...
      intro:
        'LED 조명은 같은 밝기의 형광등 대비 약 50~70% 전력을 절감합니다. 일반 가정에서 형광등 20개를 LED로 교체하면 연간 수만 원 이상의 전기요금 절감 효과를 기대할 수 있습니다. 조명 이외에도 에너지바우처, 저소득층 에너지 효율 개선사업(에어컨·보일러) 등 다른 에너지 복지사업도 함께 확인하세요.',
...
export const ledLightingSupportSpokes: SpokeData[] = [
  ...
  },
  {
    ...
    content:
      '저소득층 가구는 읍·면·동 주민센터, 사회복지시설은 시·군·구 에너지 담당부서에 신청. 한국에너지재단 ☎02-6913-2173.',
  },
  {
    slug: 'exclusion',
    role: 'exclusion',
    title: '에너지 취약계층 LED 조명 무상교체 지원 제외 — LED 설치·5년 이내 교체',
    content:
      '이미 LED 조명 설치·최근 5년 이내 교체 이력·준공 5년 미경과 시설·리모델링 계획이 있는 경우 지원 불가.',
  },
  {
    slug: 'rental',
    role: 'rental',
    title: '영구임대주택 LED 조명 무상교체 — 단지 단위 협약 신청',
    content:
      '영구임대주택은 단지 단위 협약 체결이 필요합니다. 관리사무소 또는 시·군·구 에너지 담당부서에 문의하세요.',
  },
];
