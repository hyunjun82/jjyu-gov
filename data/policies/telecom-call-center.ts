...
export const telecomCallCenterSpokes = [
  { slug: 'skt', role: 'eligibility', title: 'SK텔레콤 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'sk-telink', role: 'eligibility', title: 'SK텔링크 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'sk-broadband', role: 'eligibility', title: 'SK브로드밴드 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 's1-mobile', role: 'eligibility', title: '에스원 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'medialog', role: 'eligibility', title: '미디어로그 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'livem', role: 'eligibility', title: '리브엠모바일 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'lguplus', role: 'eligibility', title: 'LG유플러스 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'lg-hellovision', role: 'eligibility', title: 'LG헬로비전 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'kt', role: 'eligibility', title: 'KT 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'kt-mmobile', role: 'eligibility', title: 'KT엠모바일 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'keunsaram', role: 'eligibility', title: '큰사람케넥트 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'kct', role: 'eligibility', title: '한국케이블텔레콤 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'inscobee', role: 'eligibility', title: '인스코비 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'hcn', role: 'eligibility', title: 'HCN 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'dlive', role: 'eligibility', title: '딜라이브 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'cmb', role: 'eligibility', title: 'CMB 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
  { slug: 'anex-telecom', role: 'eligibility', title: '에넥스텔레콤 고객센터 전화번호 및 상담원 연결·개통 문의 안내' },
];
