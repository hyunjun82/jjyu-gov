  ...
  qa: [
    {
      ...
      act: { cue: '상한액에 걸리는지 여부로 실수령액이 갈립니다. 내 통상임금 기준으로 계산해 보세요.', label: '급여 모의계산 해보기', url: 'https://www.work24.go.kr/cm/c/f/1200/selecSimulateCalc.do?currentPageNo=1&recordCountPerPage=10' },
