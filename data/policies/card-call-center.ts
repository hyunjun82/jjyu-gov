 ...
 *
 * 카드사에서 조심할 것
 *   · 상담시간을 공개하지 않는 곳이 많다. ARS 가 24시간이라 적을 이유가 없어서다.
...
export const cardCallCenterPolicy = {
  ...
  deadline: '분실신고는 24시간, 일반 상담은 대부분 평일 주간',
  hideAmountBox: true,
  views: 0,
  applyUrl: NAVER_MAP,
  ctaLabel: '가까운 지점 찾기',
  ...
  keyFacts: {
    ...
    상담시간: {
      value: '공식 안내에 상담시간을 적지 않는 회사가 많다 — 없으면 없다고 표기한다',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '카드사는 상담시간을 공식 페이지에 적지 않는 곳이 많습니다. ARS 가 24시간 돌아가서 시간을 적을 이유가 없기 때문입니다. 다만 상담원 연결은 대부분 평일 주간에만 됩니다. 여기서는 공식 안내에 시간이 적혀 있는 회사만 그 시간을 쓰고, 없는 회사는 표기 없음으로 둡니다. 다른 곳에서 본 시간을 옮겨 적으면 닫힌 창구에 전화하게 되기 때문입니다.',
      highlights: ['24시간', '평일 주간', '표기 없음'],
      sourceNote: '* 출처: 각 카드사 공식 고객센터 안내 (2026-08-26 확인)',
    },
    {
      q: '해외에서 카드 문제가 생기면 어디로 거나요?', anchor: 'q-abroad',
      intro:
        '해외 전용 번호가 따로 있습니다. 국내 대표번호는 해외에서 걸리지 않는 경우가 많아 국가번호를 붙인 번호를 따로 안내합니다. 신한카드는 해외에서 82-2-3420-7000, 해외이용 관련 상담은 1833-2092 로 갈립니다. 출국 전에 이 번호를 저장해 두시면 현지에서 검색하지 않아도 됩니다.',
