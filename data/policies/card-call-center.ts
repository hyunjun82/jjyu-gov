...
export const cardCallCenterSpokes = [
  ...
  { slug: 'kfcc-card', role: 'eligibility', title: '새마을금고 카드 고객센터 전화번호·상담원 연결·영업시간, 분실신고는 몇 번?' },
  { slug: 'kb-card', role: 'eligibility', title: 'KB국민카드 고객센터 전화번호·상담원 연결·영업시간, 분실신고는 몇 번?' },
  { slug: 'jeju-card', role: 'eligibility', title: '제주은행 카드 고객센터 전화번호·상담원 연결·영업시간, 분실신고는 몇 번?' },
