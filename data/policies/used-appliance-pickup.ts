...
export const usedAppliancePickupPolicy: PolicyData = {
  ...
  keyFacts: {
    운영_기관: {
      value: 'E-순환거버넌스 (기후에너지환경부 지정 회수·재활용 공제조합)',
  ...
  qa: [
    {
      ...
      intro: '폐가전 무상 방문수거 서비스는 기후에너지환경부와 한국전자제품환경협회가 운영하는 제도로, 가정에서 버리기 어려운 대형 폐가전제품을 무료로 방문하여 수거해 가는 서비스입니다. 냉장고·세탁기·에어컨·TV 등 대형 가전을 혼자 처분하기 어려운 경우 전화(1599-0903)나 홈페이지(15990903.or.kr)로 신청하면 지정 날짜에 직원이 방문하여 수거합니다. 수거 비용은 전혀 없으며, 수거된 제품은 친환경 방식으로 재활용됩니다.',
    ...
    },
    {
      ...
      intro: '소형 가전 5개 미만의 경우 무상 방문수거 서비스를 이용할 수 없습니다. 이런 경우에는 한국전자제품환경협회가 운영하는 무상수거 보조 방법을 활용할 수 있습니다. 배출 스티커를 발급받아 제품에 부착한 후 문 앞에 내놓으면 수거해 가는 방식이 있습니다. 또한 대형마트·전자제품 판매점·주민센터에 설치된 소형 폐가전 수거함에 직접 가져다 놓을 수도 있습니다. 지역 행정복지센터나 기후에너지환경부 콜센터에서 가까운 수거함 위치를 안내받을 수 있습니다.',
