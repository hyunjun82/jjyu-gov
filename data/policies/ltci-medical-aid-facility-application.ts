...
export const ltciMedicalAidFacilityApplicationPolicy = {
  ...
  titleKeywords: { k1: '노인장기요양보험법 제58조 및 시행령 제28조에 따라', k2: '의료급여법에 따른 수급권자가 장기요양기관에 입소하거나 이용할 때 시·군·구청장에게 신청하는 절차입니다', k3: '장기요양인정서 사본이 필요합니다', k4: '접수·처리기관은 특별자치시장, 특별자치도지사, 시장·군수·구청장입니다' },
  ...
  keyFacts: {
    ...
    담당기관: { value: '보건복지부 요양보험운영과', source: { url: 'https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=13520000083', text: '담당기관', verifiedAt: '2026-07-17' } },
    접수처리기관: { value: '특별자치시장, 특별자치도지사, 시장·군수·구청장', source: { url: 'https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=13520000083', text: '접수기관', verifiedAt: '2026-07-17' } },
    처리유형: { value: '신규신청, 갱신, 변경, 해지 모두 한 민원으로 처리', source: { url: 'https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=13520000083', text: '처리유형', verifiedAt: '2026-07-17' } },
  },
  qa: [
    {
      q: '장기요양기관 입소·이용 신청이 뭔가요?', anchor: 'q-basic',
      intro: '이 민원은 노인장기요양보험법 제58조 및 시행령 제28조에 따라 국가와 지자체가 의료급여수급권자의 장기요양 이용 비용을 부담하기 때문에, 의료급여법에 따른 수급권자가 장기요양기관에 입소하거나 이용할 때 시·군·구청장에게 신청하는 절차입니다. 신규신청, 갱신, 변경, 해지 모두 이 한 민원으로 처리됩니다. 입소·이용 상황이 바뀔 때마다 신청 절차를 거쳐야 비용 부담 혜택을 계속 받을 수 있습니다.',
      highlights: ['의료급여수급권자의 장기요양기관 입소·이용 신청', '노인장기요양보험법 제58조·시행령 제28조 근거', '신규·갱신·변경·해지를 한 민원으로 처리', '상황 변화 시마다 신청해야 비용 부담 혜택 유지'],
      box: { label: '핵심', content: '의료급여수급권자가 장기요양기관 입소·이용 시 시·군·구청장에 신청하는 절차.' },
      sourceNote: '* 출처: 정부24 장기요양기관 입소·이용 신청(신규, 갱신, 변경, 해지)',
    },
    {
      q: '누가 신청할 수 있나요?', anchor: 'q-eligibility',
      intro: '신청자격은 본인 또는 대리인입니다. 대상은 의료급여법에 따른 수급권자로서 노인장기요양보험법상 장기요양기관을 입소·이용하려는 사람입니다. 신규신청뿐 아니라 갱신, 변경(입소기관 변경 등), 해지(퇴소 등)도 모두 신청 대상입니다. 본인이 의료급여수급권자에 해당하는지 확실하지 않다면 관할 시·군·구에 미리 확인해두는 것이 좋으며, 대리인이 신청하는 경우 관련 위임 서류를 함께 준비하는 것이 안전합니다.',
      ...
      table: { caption: '신청 유형', headers: ['유형', '적용 상황'], rows: [['신규신청', '처음 입소·이용'], ['갱신', '기존 이용 연장'], ['변경', '입소기관 변경 등'], ['해지', '퇴소 등']] },
      sourceNote: '* 출처: 정부24 장기요양기관 입소·이용 신청(신규, 갱신, 변경, 해지)',
    },
    {
      q: '어떤 서류가 필요한가요?', anchor: 'q-docs',
      intro: '장기요양인정서 사본이 필요합니다. 주민등록 등·초본, 의료급여법 제3조제1항제1호에 따른 의료급여수급자는 의료급여수급자 증명서, 그 외의 규정에 따른 수급자는 의료급여증은 행정정보공동이용을 통해 담당공무원이 확인할 수 있어 별도 제출이 필요 없습니다. 장기요양인정서를 분실했다면 국민건강보험공단 노인장기요양보험운영센터에서 재발급받을 수 있으니, 미리 확인해 두면 신청이 지연되지 않습니다.',
    ...
    },
    {
      ...
      intro: '수수료는 없습니다. 처리기간은 총 7일이 소요됩니다. 신규신청, 갱신, 변경, 해지 모두 동일하게 이 처리기간이 적용됩니다. 입소·이용 일정에 맞춰 미리 여유를 두고 신청하는 것이 좋으며, 서류가 미비하면 처리기간이 더 늘어날 수 있으므로, 접수 전 필요서류를 꼼꼼히 확인하는 것이 좋으며, 입소·이용 예정일을 감안해 여유 있게 신청하는 것이 안전하며, 처리 상황이 궁금하면 관할기관에 문의할 수 있습니다.',
      highlights: ['수수료: 없음', '처리기간: 총 7일', '신규·갱신·변경·해지 모두 동일 처리기간', '장기요양인정서 사본 준비가 처리 속도에 영향'],
      box: { label: '수수료·처리기간', content: '수수료 없음, 처리 총 7일.' },
      table: { caption: '수수료·처리기간 요약', headers: ['항목', '내용'], rows: [['수수료', '없음'], ['처리기간', '총 7일']] },
      sourceNote: '* 출처: 정부24 장기요양기관 입소·이용 신청(신규, 갱신, 변경, 해지)',
    },
    {
      q: '어디서, 어떻게 신청하나요?', anchor: 'q-apply-method',
      intro: '신청 방법은 현장제출 및 기타입니다. 접수·처리기관은 특별자치시장, 특별자치도지사, 시장·군수·구청장입니다. 관할 시·군·구청을 방문해 장기요양기관 입소·이용 신청서를 제출합니다. 신청자격은 본인 또는 대리인이며, 장기요양인정서 사본을 미리 준비해두면 접수가 더 수월하며, 입소하려는 장기요양기관과도 미리 협의해두는 것이 좋으며, 관할 시·군·구청 위치를 미리 확인해두면 방문이 수월합니다.',
    ...
    },
    {
      ...
      intro: '이 민원의 제도를 담당하는 중앙행정기관은 보건복지부 요양보험운영과입니다. 개별 민원(실제 접수·처리)에 대한 문의는 관할 특별자치시·특별자치도·시·군·구(관할 처리기관)에 직접 연락하는 것이 정확합니다. 정부24 콜센터(1588-2188), 정부민원안내콜센터(국번없이 110)를 통해서도 일반적인 안내를 받을 수 있습니다. 처리 상황이 궁금하면 신청서를 접수한 관할기관에 직접 문의하는 것이 가장 정확합니다.',
    ...
    {
      q: '신청 없이 입소·이용하면 어떻게 되나요?', anchor: 'q-penalty',
      intro: '신청 없이 장기요양기관에 입소·이용하면 국가·지자체가 부담하는 의료급여수급권자 비용 지원 혜택을 받지 못할 수 있습니다. 이 신청은 입소·이용 전 반드시 거쳐야 하는 절차이므로, 신규 입소는 물론 기관 변경이나 해지 시에도 그때그때 신청해야 합니다. 신청을 누락하면 비용 부담이 본인에게 전가될 수 있으므로 유의해야 하며, 입소·이용 상황이 바뀔 때마다 잊지 말고 신청 절차를 챙겨야 합니다.',
      highlights: ['미신청 시 비용 지원 혜택을 받지 못할 수 있음', '입소·이용 전 반드시 거쳐야 하는 절차', '기관 변경·해지 시에도 그때그때 신청 필요', '신청 누락 시 비용 부담이 본인에게 전가될 수 있음'],
      box: { label: '미신청 유의', content: '신청 없이 입소·이용하면 비용 지원 혜택을 받지 못할 수 있음.' },
      sourceNote: '* 출처: 정부24 장기요양기관 입소·이용 신청(신규, 갱신, 변경, 해지)',
    },
  ],
  faq: [
