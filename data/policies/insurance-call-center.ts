...
export const insuranceCallCenterSpokes = [
  ...
  { slug: 'shinhan-ez-insurance', role: 'eligibility', title: '신한EZ손해보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  ...
  { slug: 'miraeasset-life', role: 'eligibility', title: '미래에셋생명 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  ...
  { slug: 'meritz-fire-direct', role: 'eligibility', title: '메리츠화재 다이렉트 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  ...
  { slug: 'lina-insurance', role: 'eligibility', title: '라이나손해보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'kyobo-lifeplanet', role: 'eligibility', title: '교보라이프플래닛 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  ...
  { slug: 'kakaopay-insurance', role: 'eligibility', title: '카카오페이손해보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'im-life', role: 'eligibility', title: 'iM라이프 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'ibk-pension', role: 'eligibility', title: 'IBK연금보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  ...
  { slug: 'chubb-life', role: 'eligibility', title: '처브라이프생명 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'carrot', role: 'eligibility', title: '한화손보 캐롯 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'cardif-life', role: 'eligibility', title: '카디프생명 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'axa-insurance', role: 'eligibility', title: 'AXA손해보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
  { slug: 'aig-insurance', role: 'eligibility', title: 'AIG손해보험 고객센터 전화번호 및 빠른 상담사 연결·위치 안내' },
