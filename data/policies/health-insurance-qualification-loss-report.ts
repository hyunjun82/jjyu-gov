...
export const healthInsuranceQualificationLossReportPolicy = {
  ...
  titleKeywords: { k1: '건강보험 가입자 자격상실 신고', k2: '지역가입자와 직장가입자 각각 다른 신고서 양식을 사용합니다', k3: '국적을 상실한 경우', k4: '국민건강보험공단지사' },
  ...
  keyFacts: {
    ...
    신청서식: { value: '건강보험 지역가입자 자격상실 신고서(별지 서식 7호), 건강보험 직장가입자 자격상실 신고서(별지 서식 8호)', source: { url: 'https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=14600000234', text: '신청서식', verifiedAt: '2026-07-18' } },
    고객센터: { value: '국민건강보험공단 고객센터 국번없이 1577-1000', source: { url: 'https://www.nhis.or.kr', text: '고객센터', verifiedAt: '2026-07-18' } },
  },
  qa: [
    {
      q: '건강보험 가입자 자격상실 신고가 뭔가요?', anchor: 'q-basic',
      intro: '건강보험 가입자 자격상실 신고는 건강보험 가입자(지역·직장가입자)가 사망, 국적상실 등 국민건강보험법 제10조제1항 각호의 자격상실사유로 그 자격을 잃게 되었을 때 이를 신고하는 민원사무입니다. 국민건강보험법 제10조제2항에 근거하며, 지역가입자와 직장가입자 각각 다른 신고서 양식을 사용합니다. 자격상실 사유가 발생했는데도 신고하지 않으면 보험료가 계속 부과될 수 있으므로, 사유가 생기면 되도록 빨리 신고하는 것이 중요합니다.',
      highlights: ['건강보험 가입자(지역·직장가입자)가 사망, 국적상실 등 국민건강보험법 제10조제1항 각호의 자격상실사유로 그 자격을 잃게 되었을 때 이를 신고하는 민원사무입니다', '국민건강보험법 제10조제2항에 근거하며, 지역가입자와 직장가입자 각각 다른 신고서 양식을 사용합니다', '자격상실 사유가 발생했는데도 신고하지 않으면 보험료가 계속 부과될 수 있으므로'],
      box: { label: '핵심', content: '사망·국적상실 등으로 건강보험 자격을 잃었을 때 신고하는 절차.' },
    },
    {
      q: '어떤 경우에 신고해야 하나요?', anchor: 'q-cases',
      intro: '건강보험 가입자가 사망한 경우, 국적을 상실한 경우 등 국민건강보험법 제10조제1항 각호에서 정한 자격상실 사유가 발생했을 때 신고해야 합니다. 지역가입자와 직장가입자 모두 해당 사유 발생 시 이 절차를 통해 신고합니다. 가족이 사망한 경우 유족이나 대리인이 대신 신고할 수 있으며, 신고가 늦어지면 상실일 이후에도 보험료가 부과될 수 있으므로 사유 발생 즉시 신고하는 것이 좋습니다.',
      highlights: ['건강보험 가입자가 사망한 경우, 국적을 상실한 경우 등 국민건강보험법 제10조제1항 각호에서 정한 자격상실 사유가 발생했을 때 신고해야 합니다', '지역가입자와 직장가입자 모두 해당 사유 발생 시 이 절차를 통해 신고합니다', '가족이 사망한 경우 유족이나 대리인이 대신 신고할 수 있으며', '사유 발생 즉시 신고하는 것이 좋습니다'],
      box: { label: '주요 신고 사유', content: '가입자 사망, 국적상실 등 법정 자격상실 사유.' },
      sourceNote: '* 출처: 정부24 건강보험 가입자 자격상실 신고',
    },
    {
      q: '어떤 서류가 필요한가요?', anchor: 'q-docs',
      intro: '구비서류는 없습니다. 건강보험 지역가입자 자격상실 신고서 또는 건강보험 직장가입자 자격상실 신고서(각 별지 서식 7호·8호)만 작성하면 되며, 별도로 준비해서 제출할 서류가 없습니다. 사망이나 국적상실 등 자격상실 사유는 국민건강보험공단이 행정정보공동이용 등을 통해 확인하는 경우가 많아, 신고인이 별도의 증빙자료를 준비할 필요가 없다는 점이 특징이며, 신고서 서식은 국민건강보험공단 홈페이지나 정부24에서 내려받을 수 있습니다.',
      highlights: ['구비서류는 없습니다', '건강보험 지역가입자 자격상실 신고서 또는 건강보험 직장가입자 자격상실 신고서(각 별지 서식 7호·8호)만 작성하면 되며', '별도로 준비해서 제출할 서류가 없습니다', '신고인이 별도의 증빙자료를 준비할 필요가 없다는 점이 특징이며'],
      box: { label: '준비서류', content: '없음. 지역·직장가입자용 신고서만 작성하면 됨.' },
      table: { caption: '가입자 유형별 신고서', headers: ['가입자 유형', '신고서'], rows: [['지역가입자', '건강보험 지역가입자 자격상실 신고서(별지 서식 7호)'], ['직장가입자', '건강보험 직장가입자 자격상실 신고서(별지 서식 8호)']] },
      sourceNote: '* 출처: 정부24 건강보험 가입자 자격상실 신고',
    },
    {
      q: '수수료와 처리기간은 어떻게 되나요?', anchor: 'q-fee-period',
      intro: '수수료는 없습니다. 처리기간은 총 3일이 소요됩니다. 신고 방법이 다양해 인터넷·모바일로도 손쉽게 신고할 수 있습니다. 처리기간은 접수일로부터 계산되므로, 사유가 발생한 날짜와 실제 신고일 사이에 간격이 생기면 그 기간 동안에는 보험료가 계속 부과될 수 있어 유의해야 합니다. 처리기간 3일은 접수 이후 국민건강보험공단 내부 처리에 걸리는 기간을 뜻하며, 신고 자체는 사유 발생 즉시 하는 것이 원칙입니다.',
      highlights: ['수수료는 없습니다', '처리기간은 총 3일이 소요됩니다', '인터넷·모바일로도 손쉽게 신고할 수 있습니다', '사유가 발생한 날짜와 실제 신고일 사이에 간격이 생기면 그 기간 동안에는 보험료가 계속 부과될 수 있어'],
    ...
    },
    {
      ...
      intro: '신청 방법은 인터넷, 방문, 팩스, 우편, 모바일, EDI입니다. 접수·처리기관은 국민건강보험공단지사입니다. 국민건강보험공단 홈페이지나 앱에서도 신고할 수 있으며, 방문이 어려운 경우 팩스나 우편으로도 신고서를 제출할 수 있어 상황에 맞는 방법을 선택하면 됩니다. EDI를 이용하는 사업장은 별도 절차 없이 기존 신고 시스템을 그대로 활용할 수 있어 편리합니다.',
      highlights: ['신청 방법은 인터넷, 방문, 팩스, 우편, 모바일, EDI입니다', '접수·처리기관은 국민건강보험공단지사입니다', '국민건강보험공단 홈페이지나 앱에서도 신고할 수 있으며', '방문이 어려운 경우 팩스나 우편으로도 신고서를 제출할 수 있어'],
      box: { label: '신청경로', content: '국민건강보험공단지사에 인터넷·방문·모바일 등으로 신고.' },
      sourceNote: '* 출처: 정부24 건강보험 가입자 자격상실 신고',
    },
    {
      q: '신고가 늦어지면 어떻게 되나요?', anchor: 'q-late-report',
      intro: '자격상실 사유가 발생했는데도 신고가 늦어지면, 실제 자격상실일 이후 기간에 대해서도 건강보험료가 계속 부과될 수 있습니다. 이미 낸 보험료가 있다면 자격상실일을 기준으로 정산되어 환급이나 추가 고지가 이루어질 수 있으므로, 사유가 발생하면 되도록 빨리 관할 국민건강보험공단지사에 신고하는 것이 좋습니다. 사망의 경우 유족이나 대리인이 사망일을 기준으로 신고할 수 있습니다.',
      highlights: ['자격상실 사유가 발생했는데도 신고가 늦어지면', '실제 자격상실일 이후 기간에 대해서도 건강보험료가 계속 부과될 수 있습니다', '자격상실일을 기준으로 정산되어 환급이나 추가 고지가 이루어질 수 있으므로', '사망의 경우 유족이나 대리인이 사망일을 기준으로 신고할 수 있습니다'],
      box: { label: '유의사항', content: '신고가 늦어지면 상실일 이후 보험료가 계속 부과될 수 있음.' },
    },
    {
      ...
      highlights: ['이 민원의 제도를 담당하는 중앙행정기관은 보건복지부 보험정책과입니다', '관할 국민건강보험공단지사(관할 처리기관)에 직접 연락하는 것이 정확합니다', '국민건강보험공단 고객센터(국번없이 1577-1000)', '정부24 콜센터(1588-2188)'],
