...
export const learningcardPolicy = {
  ...
  qa: [
    ...
    },
    {
      ...
      intro: '국민내일배움카드는 만 15세 이상 64세 이하 국민이라면 재직자·실업자·자영업자·특수형태근로종사자 누구나 신청할 수 있습니다. 다만 공무원·사립학교 교직원·만 65세 이상·외국인(일부 예외) 등은 발급 대상에서 제외됩니다. 재직자의 경우 사업주의 동의 없이도 본인이 직접 신청 가능합니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
    ...
    },
    {
      q: '어떻게 신청하나요?',
      anchor: 'q-apply',
      intro: '신청은 온라인(고용24)과 방문(고용센터) 두 가지 방법이 있으며, 온라인이 가장 빠르고 편리합니다. 발급 신청 후 14일 이내 카드 발급 결과가 통보되며, 발급 결정 시 우편으로 카드가 발송됩니다. 실업자는 발급 전 직업심리검사와 상담을 받아야 하며, 재직자는 별도 상담 없이 바로 발급 가능합니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
    ...
    },
    {
      q: '자기부담금은 얼마인가요?',
      anchor: 'q-self-cost',
      intro: '훈련비의 45~85%가 정부 지원되며 나머지 15~55%는 본인 부담입니다. 자기부담률은 훈련 분야·계층에 따라 차등 적용되며, 국가기간·전략산업 분야는 자부담이 낮고, 일반 직무 분야는 자부담이 높습니다. 기초생활수급자·차상위계층·한부모가족 등 취약계층은 자기부담 면제(0%) 또는 매우 낮게 책정됩니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
    ...
    },
    {
      ...
      anchor: 'q-training',
      intro: '고용노동부가 사전 적합 인정한 훈련과정만 카드로 수강할 수 있습니다. 직무능력 향상, 자격증 취득, 신기술(IT·AI·반도체), 외국어, 디지털 콘텐츠, 서비스업 등 다양한 분야가 포함되며, 고용24에서 「내일배움카드 적합과정」 검색으로 확인 가능합니다. 운전면허·취미 과정은 지원 대상에서 제외됩니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
    ...
    },
    {
      ...
      anchor: 'q-overlap',
      intro: '국민내일배움카드와 실업급여는 별개 제도로 동시에 받을 수 있습니다. 실업급여 수급 중에도 카드를 발급받아 훈련을 받을 수 있으며, 적극적 구직활동의 일환으로 인정되어 실업인정에도 유리합니다. 다만 동일 훈련에 대해 다른 정부 지원(K-디지털 트레이닝 등)을 중복 수령할 수는 없습니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
    ...
    },
    {
      q: '5년이 지나면 어떻게 되나요?',
      anchor: 'q-expire',
      intro: '카드 발급일로부터 5년이 지나면 잔여 지원금은 자동 소멸됩니다. 5년 경과 후 재신청을 통해 카드를 다시 발급받을 수 있으며, 재발급 시에도 동일하게 5년간 300~500만원 한도가 적용됩니다. 단, 부정수급 등으로 제재를 받은 경우 일정 기간 재발급이 제한될 수 있습니다. 본 항목은 에 대한 정부 공식 자료 기반 정리이며, 신청 대상·지급 금액·신청 방법은 부처 공식 사이트에서 최종 확인이 필요합니다. 자격 요건과 예외 사항은 매년 일부 변경될 수 있어 신청 전 1차 출처 점검을 권장합니다.',
