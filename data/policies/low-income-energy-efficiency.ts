  ...
  qa: [
    {
      ...
      intro:
        '저소득층 에너지 효율 개선사업은 냉·난방비 부담이 큰 취약계층 가구와 사회복지시설을 위한 지원으로, 자격 요건이 명확하게 정해져 있습니다. 신청 전 아래 대상 요건을 반드시 확인하세요.',
    ...
    },
    {
      ...
      intro:
        '냉방과 난방 두 분야로 나뉘어 지원됩니다. 냉방은 고효율 에어컨 보급·설치, 난방은 단열 시공·창호·바닥 공사 및 고효율 보일러 교체를 지원합니다. 2025년부터 냉방·난방 신청서가 하나로 통합되어, 한 번의 신청으로 두 가지 모두 신청할 수 있습니다.',
    ...
    },
    {
      ...
      intro:
        '냉방 지원과 난방 지원은 일정이 다릅니다. 냉방은 상반기(2~4월 추천), 난방은 연중(2~10월 추천)으로 진행됩니다. 2025년부터 한 장의 신청서로 냉방·난방 동시 신청이 가능합니다.',
    ...
    },
    {
      ...
      question: '어떻게 신청하나요?',
      intro:
        '본인이 직접 읍·면·동 주민센터(행정복지센터)에 방문하여 신청합니다. 직접 신청이 어려운 복지 사각지대 가구는 기초지자체(행정복지센터)의 추천을 통해 지원받을 수 있습니다. 사회복지시설은 해당 지역 기초지자체를 통해 추천을 신청합니다.',
    ...
    },
    {
      ...
      intro:
        '저소득층 에너지효율개선사업에 관한 상담 및 문의는 전담 콜센터와 한국에너지재단을 통해 받을 수 있습니다. 지역 담당자 연결이 필요하면 주소지 읍·면·동 주민센터를 통해서도 안내받을 수 있습니다.',
    ...
    },
    {
      ...
      intro:
        '저소득층 에너지 효율 개선사업은 「에너지법」에 근거하여 정부가 시행하는 공식 사업입니다. 사업시행자는 한국에너지재단이며, 산업통상자원부 지침에 따라 운영됩니다.',
    ...
    },
    {
      ...
      intro:
        '이 사업은 현물(시공·물품) 지원이라 현금으로 직접 지급되지 않으며, 시공업체가 방문하여 직접 시공합니다. 에너지바우처·EERS 취약계층 가스보일러 지원 등 다른 에너지 지원 사업과 중복 신청 여부를 사전에 확인하는 것이 좋습니다.',
