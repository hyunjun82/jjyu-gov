...
export const onlineCallCenterSpokes = [
  ...
  { slug: 'amorepacific', role: 'eligibility', title: '아모레퍼시픽 고객센터 전화번호 및 상담원 연결·문의 안내' },
  ...
  { slug: 'kyobo-book', role: 'eligibility', title: '교보문고 고객센터 전화번호 및 상담원 연결·문의 안내' },
  ...
  { slug: 'kakaopay', role: 'eligibility', title: '카카오페이 고객센터 전화번호 및 상담원 연결·문의 안내' },
  { slug: 'toss', role: 'eligibility', title: '토스 고객센터 전화번호 및 상담원 연결·문의 안내' },
