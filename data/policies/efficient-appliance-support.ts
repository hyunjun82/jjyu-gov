  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        ...
        items: [
          ...
          '⑤ 심사 후 환급금 계좌 입금 (심사 완료 순으로 순차 지급)',
        ],
      },
      box2: {
        title: '필요 서류',
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ['가군 (장애인·유공자·기초수급·차상위·사회복지시설·생명유지장치)', '30%', '100만 원 이상 구매 시 최대 30만 원'],
          ['나군 (다자녀·대가족·출산가구)', '15%', '200만 원 이상 구매 시 최대 30만 원'],
        ],
      },
      sourceNote: '한전 에너지마켓플레이스 (support.kepco.co.kr)',
    },
...
export const efficientApplianceSupportSpokes: SpokeData[] = [
  {
    slug: '대상',
    role: 'target',
    title: '고효율가전 환급 대상, 복지할인 가구 가군·나군 누가 받나',
    content: '한전 전기요금 복지할인 가구 대상. 가군(장애인·유공자·기초수급·차상위) 30%, 나군(3자녀·출산·대가족) 15% 환급.',
  },
  {
    slug: '환급률',
    role: 'benefit',
    title: '고효율가전 환급 얼마 받나, 가군 30% 나군 15% 한도 30만원',
    content: '가군 30%·나군 15% 환급, 가구당 30만원 한도(합산). 예산 100억 소진 시 조기 마감.',
  },
  {
    slug: '품목',
    role: 'item',
    title: '고효율가전 환급 품목 11종, 에어컨·냉장고 몇 등급까지 되나',
    content: '11종(TV·에어컨·냉장고·세탁기·전기밥솥·공기청정기·김치냉장고·제습기·진공청소기·의류건조기·식기세척기). 기본 1등급, 에어컨 벽걸이 1등급·그외 1~3등급.',
  },
  {
    slug: '신청방법',
    role: 'apply',
    title: '고효율가전 환급 신청 방법과 서류, 거래내역서·라벨 사진까지',
    content: 'en-ter.co.kr/support 온라인 신청. 효율등급 라벨·제조번호 명판 사진·거래내역서·구매증빙. 2026.2.9~12.31, 1.1 이후 구매 소급.',
  },
  {
    slug: '에어컨',
    role: 'aircon',
    title: '에어컨 사면 고효율가전 환급 얼마? 벽걸이 1등급·스탠드 등급',
    content: '에어컨 벽걸이 1등급·스탠드 등 1~3등급 대상. 가군 30%·나군 15%(30만원 한도). 폭염 전 구매·신청 권장.',
  },
];
