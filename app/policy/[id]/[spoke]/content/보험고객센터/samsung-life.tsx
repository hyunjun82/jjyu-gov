...
export const samsungLifeCallCenterSpokeContent: SpokeData = {
  ...
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 평일 09:00 ~ 18:00이며 이 시간을 벗어나면 상담사 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담사 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '상담사 상담은 대표 콜센터 평일 09:00 ~ 18:00입니다. 공식 안내 기준으로 이 시간을 벗어나면 상담사 연결이 안 됩니다. 야간·공휴일 운영 표기가 따로 없으니, 급한 용건도 대표 콜센터 평일 09:00 ~ 18:00 안에 거셔야 합니다.',
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '상담사 상담은 대표 콜센터 평일 09:00 ~ 18:00입니다. 공식 안내에 야간·공휴일 운영 표기가 없어, 이 시간을 벗어나면 연결되지 않습니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
  ...
  callCenter: {
    ...
    "offhourNote": "공식 안내 기준으로 대표 콜센터 평일 09:00 ~ 18:00을 벗어나면 상담사 연결이 안 됩니다. 계약 조회·변경과 보험금 청구는 평일 상담시간에 거는 편이 빠릅니다.",
