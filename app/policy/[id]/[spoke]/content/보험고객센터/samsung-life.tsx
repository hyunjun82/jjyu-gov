...
export const samsungLifeCallCenterSpokeContent: SpokeData = {
  ...
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담사 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '삼성생명 고객센터 전화번호 1588-3114. 상담시간 대표 콜센터 (평일 09:00 ~ 18:00). 업무별 번호 3개와 상담원 연결 방법까지 2026-08-25 공식 안내 기준.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '삼성생명 공식 안내에는 상담사에게 바로 넘어가는 단축번호가 공개돼 있지 않습니다. 공식 안내에 적힌 상담사 상담시간은 대표 콜센터 (평일 09:00 ~ 18:00)입니다.',
    ...
    },
    {
      ...
      intro:
        '상담사 상담은 공식 안내 기준 대표 콜센터 (평일 09:00 ~ 18:00)입니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '삼성생명 창구 위치는 지도 검색이 가장 빠릅니다. 창구에서만 되는 일이 아니면 안 가셔도 됩니다.',
        label: '가까운 창구 찾아보기',
        url: MAP,
      },
    ...
    },
    {
      ...
      act: {
        cue: '삼성생명 상담시간은 공식 안내 기준 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 가입한 곳이 여럿이면 미리 봐 두는 게 낫습니다.',
        label: '보험사 전체 목록 열기',
        url: HUB,
      },
