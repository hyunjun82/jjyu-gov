...
export const samsungLifeCallCenterSpokeContent: SpokeData = {
  ...
  heroAct: { label: '1588-3114 지금 연결하기', href: TEL },
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '삼성생명 공식 안내는 상담사 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담사 연결 항목을 고르시면 됩니다. 다만 이건 대표 콜센터 평일 09:00 ~ 18:00에만 됩니다. 그 시간을 벗어나면 상담사 연결 항목 자체가 없고 사고접수·긴급출동 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      act: {
        cue: '삼성생명 상담은 09:00 ~ 18:00 안에서만 됩니다. 회사마다 갈리니 한자리에서 비교해 보세요.',
        label: '보험사 전체 목록 열기',
        url: HUB,
      },
