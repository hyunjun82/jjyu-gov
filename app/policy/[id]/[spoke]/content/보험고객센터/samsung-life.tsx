...
export const samsungLifeCallCenterSpokeContent: SpokeData = {
  h1: '삼성생명 고객센터 전화번호 및 빠른 상담사 연결·위치 안내',
  breadcrumb: '삼성생명 고객센터',
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 평일 09:00 ~ 18:00이며 사고접수는 야간·공휴일에도 가능합니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담사 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '삼성생명 고객센터 전화번호 1588-3114. 상담시간 대표 콜센터 평일 09:00 ~ 18:00, 야간·공휴일에는 사고접수·긴급출동만 접수됩니다. 업무별 번호 3개와 ARS 메뉴, 본사 위치까지 2026-08-25 공식 안내 기준.',
  dateModified: '2026-08-25T09:00:00+09:00',

  heroHook:
    '급할 때 번호부터 찾게 되는데요. 삼성생명 대표번호는 1588-3114 하나로 통합돼 있습니다. 다만 공식 안내에 ARS 단축번호가 공개돼 있지 않아, 안내 음성을 듣고 해당 항목을 고르셔야 합니다. 시간대도 갈립니다 — 대표 콜센터 평일 09:00 ~ 18:00에는 상담사가 받고, 평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가과 주말·공휴일 상담사 연결 불가에는 사고접수·긴급출동 위주로 돌아갑니다. 그럼 지금 바로 거시는 게 빠르겠죠.',
  heroAct: { label: '1588-3114 전화 걸기', href: TEL },

  keyFacts: {
    '대표번호': '1588-3114 (대표 콜센터)',
    '상담 가능 시간': '대표 콜센터 평일 09:00 ~ 18:00',
    '야간': '평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '삼성생명은 공식 안내에 ARS 단축번호를 공개하지 않습니다. 안내 음성을 끝까지 듣고 상담사 연결 항목을 고르시면 됩니다. 다만 이건 대표 콜센터 평일 09:00 ~ 18:00에만 됩니다. 그 시간을 벗어나면 상담사 연결 항목 자체가 없고 사고접수·긴급출동 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      intro:
        '상담사 상담은 대표 콜센터 평일 09:00 ~ 18:00입니다. 그 밖의 시간이 완전히 닫히는 건 아닙니다. 평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가과 주말·공휴일 상담사 연결 불가에는 별도 ARS 가 돌아가서 자동차 사고접수와 긴급출동을 받습니다. 아래가 야간·휴일에 눌러야 하는 번호입니다. 주간과 번호가 다르니 그대로 누르면 엉뚱한 곳으로 갑니다.',
      highlights: ['대표 콜센터 평일 09:00 ~ 18:00', '평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가', '주말·공휴일 상담사 연결 불가'],
      table: {
        headers: ['번호', '야간·휴일 (평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가 / 주말·공휴일 상담사 연결 불가)'],
        rows: [],
      },
      box: {
        label: '통화료',
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '공식 안내에 ARS 단축번호가 나와 있지 않습니다. 안내 음성에 따라 상담사 연결 항목을 고르세요. 대표 콜센터 평일 09:00 ~ 18:00에만 가능합니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
      q: '주말이나 공휴일에도 상담이 되나요?',
      a: '상담사 상담은 대표 콜센터 평일 09:00 ~ 18:00입니다. 평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가과 주말·공휴일 상담사 연결 불가에는 사고접수·긴급출동 중심의 ARS 가 운영됩니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
    ...
    {
      q: '점심시간에도 상담이 되나요?',
      a: '삼성생명 공식 고객센터 안내에는 점심시간 휴무 표기가 없습니다. 상담 가능 시간은 대표 콜센터 평일 09:00 ~ 18:00으로 안내되어 있고, 그 시간 안에서는 점심시간이라고 따로 끊긴다는 안내가 없습니다. 다만 상담사 수가 줄어 대기가 길어질 수는 있으니, 급하지 않다면 오전 이른 시간에 거는 편이 낫습니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
    ...
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: '삼성생명 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 대부분의 업무는 방문 없이 전화·앱으로 끝납니다.',
      source: '삼성생명 사업자 정보',
  ...
  callCenter: {
    ...
    "hours": {
      ...
      "night": "평일 09:00 ~ 18:00 외 시간은 상담사 연결 불가",
