...
export const 대상자조회SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      anchor: 'no-notice',
      act: { cue: '통보를 기다리는 것보다 직접 조회가 빠릅니다. 추심이 계속 온다면 아직 매입 전이거나 대상이 아닐 수 있습니다.' },
    ...
    },
    {
      ...
      anchor: 'acquisition',
      act: { cue: '매입이 끝나면 그날부터 추심이 멈춥니다. 내 채무가 매입 대상인지부터 확인해야 순서가 잡힙니다.' },
    ...
    },
    {
      ...
      act: { cue: '회원가입 없이 간편인증만으로 조회됩니다. 지원 대상 요건을 알고 들어가면 결과가 바로 읽힙니다.' },
