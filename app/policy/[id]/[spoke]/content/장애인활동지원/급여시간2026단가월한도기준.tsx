...
export const 장애인활동지원급여시간2026단가월한도기준SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        label: '소득 구간별 본인부담금',
        content: '기초생활수급자: 면제 (0원) 차상위계층: 대폭 감면 (최저 수준) 중간 소득 구간: 소득인정액 비례 부과 상위 소득 구간: 월 최대 216,200원 (2026년 상한)',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '2026년 주요 변경사항',
        content: '단가 인상: 활동지원 단가 17,270원으로 인상 (최저임금 연동) 가산급여 확대: 205시간 → 258시간 (독거·취약 가구) 본인부담 상한 조정: 2026년 기준 월 216,200원',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '방문목욕·방문간호 문의',
        content: '국민연금공단: ☎1355 보건복지부 장애인활동지원 고시 확인 담당 활동지원기관에도 문의 가능',
      },
    },
    {
