...
export const 아동급식카드지원대상결식우려아동기준중위소득SpokeContent: SpokeData = {
  ...
  heroHook:
    '아동급식카드가 중위소득 52% 넘으면 안 되는 줄 아시는 분이 계십니다. 기준은 있지만 그게 전부가 아닙니다. 소득이 넘어도 지자체장이 결식 우려가 있다고 인정하면 지원받을 수 있는데요. 다만 지자체마다 운영 기준이 달라 사는 곳에서 확인해야 합니다. 그럼 우리 지역 기준부터 알아보셔야겠죠.',
  heroAct: { label: '아동급식 지원 신청하기' },
