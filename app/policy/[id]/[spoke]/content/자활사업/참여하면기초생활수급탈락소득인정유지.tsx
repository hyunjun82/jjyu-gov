  ...
  qa: [
    {
      ...
      anchor: 'income-calc',
      intro: '자활사업 소득의 30%를 공제한 나머지를 소득인정액에 반영합니다. 예를 들어 사회서비스형 월 급여 118만원이라면 30% 공제 후 82만원이 소득인정액에 반영됩니다. 생계급여는 소득인정액이 늘어난 만큼 감액되어 지급되므로 실제로 받는 총 금액(자활급여+생계급여)은 늘어납니다.',
    ...
    },
    {
      ...
      box: {
        label: '탈락 기준 및 특례',
        content: '소득인정액 > 선정 기준 → 해당 급여 중단 자활급여특례: 자활 참여로 소득 초과 시 1년간 의료급여 유지 이행급여특례: 취업 성공 시 일정 기간 의료급여 등 유지',
      },
    },
    {
      q: '자활급여특례란 무엇인가요?',
    ...
    },
    {
      ...
      box: {
        ...
        content: '매월 소득 신고: 자활근로 소득을 주민센터에 신고 추가 소득 발생 시: 즉시 담당자에게 신고하여 수급 조정 탈락 예고 시: 이의신청 또는 자활급여특례 연계 요청',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '가구 소득인정액 영향',
        content: '참여자 소득 → 가구 소득인정액에 반영 가구 전체 급여 수준 조정 가능 미리 담당자와 상담하여 영향 범위 확인',
      },
    },
    {
      ...
      box: {
        label: '추가 소득 신고 원칙',
        content: '모든 추가 소득(아르바이트·부업 등) 즉시 신고 미신고 시 나중에 환수 처분 발생 신고 방법: 주민센터 방문 또는 담당자 연락',
      },
    },
  ],
  faqData: [
