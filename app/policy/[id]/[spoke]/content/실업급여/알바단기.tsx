...
export const 알바단기SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      anchor: 'deduction',
      intro:
        '알바한 날 수 × 1일 구직급여액이 차감됩니다. 시급이 최저임금이든 높은 시급이든 차감 기준은 동일하게 근무 일수만 봅니다. 예를 들어 1일 구직급여가 66,048원(2026년 하한액)이고 한 달에 5일 알바를 했다면 330,240원(=66,048 × 5)이 차감됩니다.',
      highlights: ['1일 구직급여액', '근무 일수'],
      table: {
        headers: ['항목', '금액'],
        rows: [
          ['1일 구직급여액 예시', '66,048원(2026 하한)'],
          ['알바 일수', '5일'],
          ['차감액', '330,240원 (= 66,048 × 5)'],
