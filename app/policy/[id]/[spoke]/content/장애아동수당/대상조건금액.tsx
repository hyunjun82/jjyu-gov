...
export const 장애아동수당대상조건금액SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        label: '장애 정도 확인 방법',
        content: '"장애 정도가 심한 장애인" → 중증 → 최대 22만원 "장애 정도가 심하지 않은 장애인" → 경증 → 11만원 모르면 행정복지센터(읍·면·동) 문의',
      },
    },
    {
      q: '신청은 보호자가 해야 하나요?',
    ...
    },
    {
      ...
      box: {
        label: '장애인 등록 절차',
        content: '행정복지센터에 장애인 등록 신청 지정 의료기관에서 장애 진단 장애 정도 심사 (국민연금공단) 장애인등록증 발급 후 수당 신청 가능',
      },
    },
    {
      q: '매년 재심사가 있나요?',
    ...
    },
    {
      ...
      box: {
        label: '중복 수급 가능 여부',
        content: '아동수당(0~95개월): 중복 가능 기초수급 급여(생계·의료 등): 중복 가능 장애수당: 불가 (18세 이상 대상이라 연령 충돌) 장애인연금: 불가 (18세 이상 대상이라 연령 충돌)',
      },
    },
  ],
  faqData: [
