...
export const 장애아동수당18세이후전환SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        label: '경증 아동 전환 절차',
        content: '18세 생일이 속한 달 이후 → 장애수당 신청 신청처: 거주지 행정복지센터 또는 복지로 필요 조건: 기초수급자 또는 차상위계층 지급액: 월 6만원',
      },
    },
    {
      ...
      box: {
        label: '중증 아동 전환 절차',
        content: '18세 생일이 속한 달 이후 → 장애인연금 신청 소득 조건: 소득인정액 단독 140만원, 부부 224만원 이하 지급액: 기초급여 34만 9,700원 + 부가급여 (최대 43만 9,700원)',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '신청 서류',
        content: '장애인등록증 (또는 복지카드) 신분증 (본인 또는 대리인) 소득재산신고서 금융정보 수집·이용·제공 동의서 → 행정복지센터 방문 또는 복지로 온라인 신청',
      },
    },
    {
      ...
      box: {
        label: '장애 정도 재심사',
        content: '주기적 재심사: 판정 기관이 정한 주기에 따라 자동 안내 자발적 신청: 장애 상태 변화 시 행정복지센터에서 재심사 신청 가능 재심사 결과에 따라 수급 제도 변경될 수 있음',
      },
    },
    {
