...
export const 한부모가족지원청소년한부모월37만원24세이하SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      anchor: 'eligibility',
      intro:
        '청소년 한부모 지원 신청 자격은 한부모 본인이 만 24세 이하이고, 자녀가 만 18세 미만(취학 시 22세까지)이어야 합니다. 소득 기준은 기준 중위소득 65% 이하입니다. 2026년 기준으로 2인 가구는 월 231만원, 3인 가구는 월 298만원 이하이면 됩니다. 조부모나 친인척과 동거하더라도 실질적으로 한부모가 자녀를 혼자 양육하는 경우 지원 대상이 될 수 있으므로 주민센터에서 확인하세요.',
      highlights: ['만 24세 이하', '65% 이하', '2인 231만원', '3인 298만원', '실질 양육'],
      table: {
        headers: ['요건', '기준'],
        rows: [
          ...
          ['소득 기준', '기준 중위소득 65% 이하'],
          ['2인 가구(2026)', '월 231만원 이하'],
          ['3인 가구(2026)', '월 298만원 이하'],
        ],
      },
      box: {
        label: '동거 가구 주의',
