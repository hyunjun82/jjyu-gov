...
export const 에너지캐시백캐시백금액계산3퍼센트절감기준SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: { label: '절약 팁', content: '에어컨 1℃ 올리면 7% 절감, 대기전력 차단으로 5~11% 절감 효과가 있습니다.' },
    },
    {
    ...
    },
    {
      ...
      anchor: 'avg-cashback',
      intro: '에너지캐시백 참여 가구의 연평균 혜택은 약 4만 9,000원입니다. 이는 월평균 4,083원에 해당합니다. 여름(7~8월)과 겨울(12~2월)에 전기 사용량이 많은 달에 캐시백도 함께 커지므로, 실제로는 특정 달에 집중되는 경향이 있습니다. 절감률이 높을수록 캐시백도 커집니다.',
      highlights: ['연평균 약 4만 9,000원', '월평균 4,083원', '여름·겨울에 집중되는 경향'],
      table: {
        headers: ['지표', '수치'],
        rows: [
          ['연평균 혜택', '약 4만 9,000원'],
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '연평균 약 4만 9,000원이면 월평균 4,083원입니다.',
      source: '한국전력공사 에너지캐시백',
      sourceUrl: 'https://en-ter.co.kr/ec/apply/info/info.do',
    },
  ],
