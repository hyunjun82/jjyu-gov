...
export const 고혈압당뇨진료비절감SpokeContent: SpokeData = {
  ...
  keyFacts: {
    ...
    약제비절감: '매월 약제비 2,000~3,000원 절감 (질환당)',
  ...
  qa: [
    {
      ...
      highlights: ['진료비 1,500원', '약제비 2,000~3,000원', '무료 서비스 포함', '소득 무관'],
      table: {
        headers: ['항목', '지원 금액', '비고'],
        rows: [
    ...
    },
    {
      ...
      highlights: ['연간 최소 42,000원 절감', '부가 서비스 포함 시 더 큼', '합병증 예방 효과'],
      table: {
        headers: ['항목', '월 지원', '연간 환산'],
        rows: [
          ['진료비', '1,500원', '18,000원'],
      ...
      box: {
        label: '장기 절감',
        content: '꾸준한 관리를 통해 뇌졸중·심근경색 등 합병증을 예방하면 수백만 원 이상의 치료비를 절감할 수 있습니다. 등록 후 꾸준히 방문하는 것이 핵심입니다.',
      },
    },
    {
