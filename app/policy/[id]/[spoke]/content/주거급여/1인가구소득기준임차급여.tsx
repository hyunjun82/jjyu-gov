...
export const 주거급여1인가구소득기준임차급여SpokeContent: SpokeData = {
  ...
  description:
    '주거급여 1인 가구: 중위소득 48%(월 123만원) 이하. 임차급여 서울 369,000원·경기인천 300,000원·광역시 247,000원·농어촌 212,000원. 부양의무자 기준 없음. 복지로(bokjiro.go.kr) 신청.',
  datePublished: '2026-05-18T09:00:00+09:00',
  dateModified: '2026-05-23T09:00:00+09:00',
  keyFacts: {
    '1인 가구 소득 기준': '월 소득인정액 1,230,834원 이하 (중위소득 48%)',
    '서울 임차급여': '월 369,000원',
    '경기·인천 임차급여': '월 300,000원',
    '광역시·세종 임차급여': '월 247,000원',
    '부양의무자 기준': '없음 (폐지)',
  },
  keyFactsHighlights: {
    '1인 가구 소득 기준': ['1,230,834원', '중위소득 48%'],
    '서울 임차급여': ['369,000원'],
    '경기·인천 임차급여': ['300,000원'],
    '부양의무자 기준': ['없음'],
  },
  qa: [
    {
      ...
      intro: '2026년 기준 1인 가구 주거급여 신청 가능 소득인정액은 월 1,230,834원 이하입니다. 이는 기준 중위소득 48%에 해당합니다. 소득인정액은 실제 소득에 재산을 소득으로 환산한 금액을 더한 값으로, 단순 월급과 다를 수 있습니다. 부양의무자 기준은 2021년부터 폐지되어 부모·자녀의 소득·재산과 무관하게 본인 가구 기준으로만 판단합니다.',
      highlights: ['1,230,834원', '중위소득 48%', '부양의무자 기준 폐지'],
      table: {
        headers: ['기준', '금액/내용'],
        rows: [
    ...
    },
    {
      ...
      intro: '임차급여(기준임대료)는 거주 지역에 따라 4개 급지로 나뉩니다. 서울(1급지)은 1인 가구 월 369,000원, 경기·인천(2급지)은 300,000원, 광역시·세종·수도권 외(3급지)는 247,000원, 그 외 지역(4급지)은 212,000원입니다. 실제 임차료가 기준임대료보다 낮으면 실제 임차료가 지급됩니다.',
      highlights: ['서울 369,000원', '경기·인천 300,000원', '247,000원', '212,000원'],
      table: {
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '주거급여 급지는 실제 거주지 기준으로 결정됩니다. 경기도에 거주하면 2급지(300,000원) 기준이 적용됩니다.',
      source: '국토교통부',
      sourceUrl: 'https://www.molit.go.kr',
    },
    {
