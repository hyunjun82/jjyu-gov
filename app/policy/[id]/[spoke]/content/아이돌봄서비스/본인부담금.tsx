...
export const 아이돌봄본인부담금SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      anchor: 'hourly',
      intro:
        '소득 구간별 유형(가·나·다·라형) 기준은 시간제와 종합형 모두 동일하게 적용됩니다. 단, 기준 시간당 요금이 다를 수 있습니다. 시간제는 시간당 12,790원, 종합형은 시간당 16,620원이 기준입니다.',
      highlights: ['시간제 12,790원', '종합형 16,620원'],
      box: { label: '안내', content: '소득 구간 유형은 동일. 시간제 기준 12,790원 / 종합형 기준 16,620원.' },
    },
    {
      q: '신청 방법은 어떻게 되나요?',
      anchor: 'apply',
