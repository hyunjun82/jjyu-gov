...
export const 장애인연금2026인상SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        label: '기존 수급자 안내',
        content: '별도 신청 없이 2026년 1월부터 자동 인상 적용 등록된 계좌로 매월 인상액 지급 금액 확인: 복지로(bokjiro.go.kr) 또는 행정복지센터',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '기초급여 + 부가급여 합산',
        content: '기초급여: 34만 9,700원 부가급여 (기초수급자 기준): 최대 9만원 합산 최대: 43만 9,700원 (부가급여는 가구 유형·소득에 따라 차등)',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '기초급여 연도별 변화',
        content: '2024년: 334,810원 2025년: 342,510원 (+7,700원) 2026년: 349,700원 (+7,190원, +2.1%) → 매년 소비자물가변동률 반영 인상',
      },
    },
    {
      ...
      box: {
        label: '신규 신청자 지급 일정',
        content: '신청 → 자격 심사(2~4주) → 자격 결정 → 다음 달부터 지급 지급액: 2026년 기준 기초급여 34만 9,700원 + 부가급여',
      },
    },
  ],
  faqData: [
