...
export const 장애인연금금액SpokeContent: SpokeData = {
  ...
  qa: [
    ...
    },
    {
      ...
      box: {
        label: '부가급여 결정 요소',
        content: '기초생활 수급 여부 (생계·의료급여 등) 가구 유형 (단독/부부) 연령 (18~64세 / 65세 이상) → 정확한 금액은 행정복지센터에서 확인',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '부부 동시 수급',
        content: '부부 모두 중증 + 소득 기준 이하 → 각각 수급 가능 단, 부부 모두 받는 경우 기초급여 각각 20% 감액 정확한 금액: 행정복지센터에서 확인',
      },
    },
    {
    ...
    },
    {
      ...
      box: {
        label: '신청 안내',
        content: '방문: 거주지 읍·면·동 행정복지센터 온라인: 복지로(bokjiro.go.kr) 준비 서류: 장애인등록증, 신분증, 소득재산신고서, 금융정보 동의서 심사 기간: 약 2~4주',
      },
    },
  ],
  faqData: [
