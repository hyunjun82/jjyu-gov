...
export const 신청기간SpokeContent: SpokeData = {
  h1: '2026 근로장려금 신청기간 정기 반기 기한후 일정 총정리',
  breadcrumb: '신청기간',
  description: '2026년 근로장려금 신청 기간을 정리했습니다. 정기 신청은 5월 1일~6월 1일, 반기 신청은 3월 1일~3월 16일(근로소득자만), 기한 후 신청은 6월 2일~12월 1일(95%만 지급)입니다.',
