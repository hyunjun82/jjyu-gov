...
export const kbCapitalLoanCallCenterSpokeContent: SpokeData = {
  h1: 'KB캐피탈 대출 고객센터 전화번호·상담 연결·영업시간, 대표번호로 될까?',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: 'KB캐피탈 대출 고객센터',
  description:
    'KB캐피탈 고객센터 대표번호는 1577-2223, 상담 운영시간은 평일 09:00 ~ 18:00이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 용건에 맞는 번호로 걸어야 한 번에 끝납니다. 아래에 업무별로 갈라 뒀습니다.',
