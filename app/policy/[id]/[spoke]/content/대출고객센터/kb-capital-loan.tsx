...
const TEL = 'tel:15772223';
const OFFICIAL = 'https://www.kbcapital.co.kr';
const MAP = 'https://map.naver.com/p/search/KB%EC%BA%90%ED%94%BC%ED%83%88';
const HUB = '/policy/loan-call-center';

export const kbCapitalLoanCallCenterSpokeContent: SpokeData = {
  h1: 'KB캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: 'KB캐피탈 대출 고객센터',
  description:
    'KB캐피탈 고객센터 대표번호는 1577-2223, 상담 운영시간은 평일 09:00 ~ 18:00이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    'KB캐피탈 고객센터 전화번호 1577-2223. 상담시간 평일 09:00 ~ 18:00, 상담원 연결은 이 시간 안에서만 됩니다. 대출 업무별 번호 4개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  dateModified: '2026-08-27T09:00:00+09:00',

  heroHook:
    'KB캐피탈 고객센터 대표번호는 1577-2223, 상담 운영시간은 평일 09:00 ~ 18:00이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  heroAct: { label: '1577-2223 상담 연결', href: TEL },

  keyFacts: {
    '대표번호': '1577-2223 (신용대출상담)',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        'KB캐피탈 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 평일 09:00 ~ 18:00에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: 'KB캐피탈은 공식 안내에 지점 주소를 따로 걸어두지 않습니다. 창구에서만 되는 일이 아니면 안 가셔도 됩니다.',
        label: '가까운 창구 찾아보기',
        url: MAP,
      },
      sourceNote: '* 출처: KB캐피탈 사업자 정보 (2026-08-27 확인)',
    },
    {
      ...
      act: {
        cue: 'KB캐피탈 상담은 평일 09:00 ~ 18:00 안에서만 됩니다. 가입한 곳이 여럿이면 미리 봐 두는 게 낫습니다.',
        label: '전체 목록 열기',
        url: HUB,
      },
  ...
  faqData: [
    ...
    {
      q: '점심시간에도 상담이 되나요?',
      a: 'KB캐피탈 공식 고객센터 안내에는 점심시간 휴무 표기가 없습니다. 상담 가능 시간은 평일 09:00 ~ 18:00으로 안내되어 있고, 그 시간 안에서는 점심시간이라고 따로 끊긴다는 안내가 없습니다. 다만 상담원 수가 줄어 대기가 길어질 수는 있으니, 급하지 않다면 오전 이른 시간에 거는 편이 낫습니다.',
      source: 'KB캐피탈 공통 푸터의 상담번호 안내 (화면 캡처 확인)',
      sourceUrl: 'https://www.kbcapital.co.kr/',
    },
    {
    ...
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: 'KB캐피탈 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 한도 조회나 서류 제출은 방문하지 않아도 전화·앱으로 처리되는 경우입니다.',
      source: 'KB캐피탈 사업자 정보',
      sourceUrl: 'https://www.kbcapital.co.kr',
    },
  ],
  ...
  callCenter: {
    ...
    "numbers": [
      ...
      },
      {
        "label": "고객상담",
        "tel": "1544-1200",
        "note": "평일 09:00 ~ 18:00 · 대출이 아닌 일반 문의"
      }
    ]
  },
};
