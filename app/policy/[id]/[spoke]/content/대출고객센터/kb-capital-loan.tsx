...
export const kbCapitalLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    'KB캐피탈 고객센터 대표번호는 1577-2223입니다. 공식 안내에 상담 가능 시간이 따로 표기돼 있지 않습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        'KB캐피탈 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 공식 안내에 대출 상담시간 표기 없음에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      intro:
        'KB캐피탈 공식 안내에는 상담원 상담 가능 시간이 표기돼 있지 않습니다. 다른 곳에서 본 시간을 옮겨 적으면 헛걸음이 되므로, 여기서는 없는 시간을 만들어 쓰지 않습니다. 대표번호로 걸어 ARS 안내를 듣는 편이 가장 확실합니다.',
    ...
    },
    {
      ...
      act: {
        cue: 'KB캐피탈은 공식 안내에 상담시간을 적어 두지 않았습니다. 두 곳 넘게 쓰신다면 미리 챙겨 두는 게 낫습니다.',
        label: '전체 목록 열기',
        url: HUB,
      },
  ...
  callCenter: {
    ...
    "offhourNote": "KB캐피탈 공식 안내에는 상담 가능 시간이 적혀 있지 않습니다. 임의로 짐작해 적지 않으니, 통화 전 공식 홈페이지에서 한 번 더 확인하세요.",
    "word": "금융사",
    "hubWord": "대출 고객센터",
    "agentWord": "상담원",
    "offhourWord": "접수·조회",
