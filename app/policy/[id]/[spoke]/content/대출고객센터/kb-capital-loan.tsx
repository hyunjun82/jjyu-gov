...
export const kbCapitalLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    'KB캐피탈 고객센터 대표번호는 1577-2223, 상담 운영시간은 평일 09:00 ~ 18:00입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    'KB캐피탈 고객센터 전화번호 1577-2223. 상담시간 평일 09:00 ~ 18:00. 대출 업무별 번호 4개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        'KB캐피탈 공식 안내에는 상담원에게 바로 넘어가는 단축번호가 공개돼 있지 않습니다. 공식 안내에 적힌 상담원 상담시간은 평일 09:00 ~ 18:00입니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: 'KB캐피탈 창구 위치는 지도 검색이 가장 빠릅니다. 창구에서만 되는 일이 아니면 안 가셔도 됩니다.',
        label: '가까운 창구 찾아보기',
        url: MAP,
      },
    ...
    },
    {
      ...
      act: {
        cue: 'KB캐피탈 상담시간은 공식 안내 기준 평일 09:00 ~ 18:00입니다. 가입한 곳이 여럿이면 미리 봐 두는 게 낫습니다.',
        label: '전체 목록 열기',
        url: HUB,
      },
