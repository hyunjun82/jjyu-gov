...
export const hyundaiCommercialLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    '현대커머셜 고객센터 대표번호는 1899-0303입니다. 공식 안내에 상담 가능 시간이 따로 표기돼 있지 않습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '현대커머셜 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 공식 안내에 대출 상담시간 표기 없음에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      intro:
        '현대커머셜 공식 안내에는 상담원 상담 가능 시간이 표기돼 있지 않습니다. 다른 곳에서 본 시간을 옮겨 적으면 헛걸음이 되므로, 여기서는 없는 시간을 만들어 쓰지 않습니다. 대표번호로 걸어 ARS 안내를 듣는 편이 가장 확실합니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '현대커머셜은 공식 안내에 지점 주소를 따로 걸어두지 않습니다. 가시기 전에 문 여는 시간을 같이 보세요.',
        label: '가까운 지점 찾기',
        url: MAP,
      },
    ...
    },
    {
      ...
      act: {
        cue: '현대커머셜은 공식 안내에 상담시간을 적어 두지 않았습니다. 어디로 걸어야 하는지는 목록에서 바로 갈립니다.',
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '현대커머셜 공식 안내에는 상담 가능 시간이 적혀 있지 않습니다. 통화 전 공식 홈페이지에서 확인하시는 편이 확실합니다.',
      source: '현대커머셜 공식 홈페이지 금융상담',
      sourceUrl: 'https://www.hyundaicommercial.com/',
    },
    {
    ...
    {
      q: '점심시간에도 상담이 되나요?',
      a: '현대커머셜 공식 고객센터 안내에는 점심시간 휴무 표기가 없습니다. 상담 가능 시간은 공식 안내에 대출 상담시간 표기 없음으로 안내되어 있고, 그 시간 안에서는 점심시간이라고 따로 끊긴다는 안내가 없습니다. 다만 상담원 수가 줄어 대기가 길어질 수는 있으니, 급하지 않다면 오전 이른 시간에 거는 편이 낫습니다.',
      source: '현대커머셜 공식 홈페이지 금융상담',
      sourceUrl: 'https://www.hyundaicommercial.com/',
    },
    {
      q: '대구·부산·인천 등 지역 고객센터 번호는 따로 있나요?',
      a: '전화 상담은 지역과 관계없이 1899-0303 한 번호로 연결됩니다. 지역별 고객센터 번호는 따로 안내되지 않습니다. 방문이 필요하면 지점·서비스망 위치를 공식 홈페이지의 지점 찾기나 지도에서 확인하세요. 지점 위치와 운영 여부는 수시로 바뀌어 이 글에는 주소를 적어두지 않습니다.',
      source: '현대커머셜 공식 홈페이지 금융상담',
      sourceUrl: 'https://www.hyundaicommercial.com/',
    },
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: '현대커머셜 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 한도 조회나 서류 제출은 방문하지 않아도 전화·앱으로 처리되는 경우입니다.',
      source: '현대커머셜 사업자 정보',
      sourceUrl: 'https://www.hyundaicommercial.com',
    },
  ],
  ...
  callCenter: {
    ...
    "offhourNote": "현대커머셜 공식 안내에는 상담 가능 시간이 적혀 있지 않습니다. 임의로 짐작해 적지 않으니, 통화 전 공식 홈페이지에서 한 번 더 확인하세요.",
    "word": "금융사",
    "hubWord": "대출 고객센터",
    "agentWord": "상담원",
    "offhourWord": "접수·조회",
