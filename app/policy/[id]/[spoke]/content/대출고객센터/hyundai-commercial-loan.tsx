...
const TEL = 'tel:18990303';
const OFFICIAL = 'https://www.hyundaicommercial.com';
const MAP = 'https://map.naver.com/p/search/%ED%98%84%EB%8C%80%EC%BB%A4%EB%A8%B8%EC%85%9C';
const HUB = '/policy/loan-call-center';

export const hyundaiCommercialLoanCallCenterSpokeContent: SpokeData = {
  h1: '현대커머셜 대출 고객센터 전화번호 및 대출 상담 연결 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '현대커머셜 대출 고객센터',
  description:
    '현대커머셜 고객센터 대표번호는 1899-0303입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '현대커머셜 고객센터 전화번호 1899-0303. 대출 업무별 번호 2개와 상담원 연결 방법까지 2026-09-03 공식 안내 기준.',
  dateModified: '2026-09-03T09:00:00+09:00',

  heroHook:
    '현대커머셜 고객센터 대표번호는 1899-0303입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  heroAct: { label: '1899-0303 연결 요청', href: TEL },
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '현대커머셜 공식 안내에는 상담원에게 바로 넘어가는 단축번호가 공개돼 있지 않습니다.',
      highlights: ['상담원 연결'],
      table: {
        headers: ['번호', '평일 주간'],
        rows: [],
    ...
    },
    {
      ...
      intro:
        '현대커머셜 공식 고객센터 안내에는 상담시간이 따로 적혀 있지 않아, 이 글에도 시간을 적지 않았습니다.',
      highlights: [],
      table: {
        headers: ['번호', '야간·휴일'],
        rows: [],
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '현대커머셜 창구 위치는 지도 검색이 가장 빠릅니다. 가시기 전에 문 여는 시간을 같이 보세요.',
        label: '가까운 지점 찾기',
        url: MAP,
      },
    ...
    },
    {
      ...
      act: {
        cue: '현대커머셜 공식 안내에 올라온 번호는 2개입니다. 어디로 걸어야 하는지는 목록에서 바로 갈립니다.',
