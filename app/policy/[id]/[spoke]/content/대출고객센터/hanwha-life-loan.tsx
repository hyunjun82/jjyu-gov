...
export const hanwhaLifeLoanCallCenterSpokeContent: SpokeData = {
  h1: '한화생명 대출 고객센터 전화번호 및 대출 상담 연결 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '한화생명 대출 고객센터',
  description:
    '한화생명 고객센터 대표번호는 1588-6363, 상담 운영시간은 평일 09:00 ~ 18:00이며 야간·공휴일 운영은 공식 안내에 따로 적혀 있습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  heroHook:
    '한화생명 고객센터 대표번호는 1588-6363, 상담 운영시간은 평일 09:00 ~ 18:00이며 야간·공휴일 운영은 공식 안내에 따로 적혀 있습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  heroAct: { label: '1588-6363 상담 받기', href: TEL },
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '한화생명 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 평일 09:00 ~ 18:00에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
      highlights: ['상담원 연결', '상담사연결 : 평일 09:00 ~ 18:00'],
      table: {
        headers: ['번호', '평일 주간 (상담사연결 : 평일 09:00 ~ 18:00)'],
        rows: [['1번', '보험계약대출'], ['4번', '부동산 및 신용대출']],
      },
      box: {
        label: '대기를 줄이는 법',
    ...
    },
    {
      ...
      intro:
        '본사는 서울특별시 영등포구 63로 50(여의도동, 63 한화생명빌딩)에 있습니다. 다만 한도 조회나 서류 제출은 방문하지 않아도 전화·앱·홈페이지로 끝나는 일이 많습니다. 서류 원본을 내야 하거나 대면 상담이 필요할 때만 움직이시는 편이 낫습니다. 방문하실 거라면 집에서 가까운 지점을 먼저 찾아보세요. 지도에서 회사명으로 검색하면 가까운 순으로 나옵니다.',
