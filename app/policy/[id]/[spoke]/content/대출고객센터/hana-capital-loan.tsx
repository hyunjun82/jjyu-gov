...
const TEL = 'tel:15997942';
const OFFICIAL = 'https://www.hanacapital.co.kr';
const MAP = 'https://map.naver.com/p/search/%ED%95%98%EB%82%98%EC%BA%90%ED%94%BC%ED%83%88';
const HUB = '/policy/loan-call-center';

export const hanaCapitalLoanCallCenterSpokeContent: SpokeData = {
  h1: '하나캐피탈 대출 고객센터 전화번호 및 대출 상담 연결 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '하나캐피탈 대출 고객센터',
  description:
    '하나캐피탈 고객센터 대표번호는 1599-7942, 상담 운영시간은 평일 09:00~18:00이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '하나캐피탈 고객센터 전화번호 1599-7942. 상담시간 평일 09:00~18:00, 상담원 연결은 이 시간 안에서만 됩니다. 대출 업무별 번호 2개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  dateModified: '2026-08-27T09:00:00+09:00',

  heroHook:
    '하나캐피탈 고객센터 대표번호는 1599-7942, 상담 운영시간은 평일 09:00~18:00이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  heroAct: { label: '1599-7942 바로 통화', href: TEL },

  keyFacts: {
    '대표번호': '1599-7942 (개인신용대출상담)',
  ...
  qa: [
    {
      q: '하나캐피탈 고객센터 전화번호 몇 번인가요?', anchor: 'q1',
      intro:
        '대표번호는 1599-7942입니다. 대출 상담, 만기연장, 중도상환, 금리 문의까지 이 번호 하나로 들어갑니다. 다만 용건이 정해져 있으면 전용번호로 거는 편이 빠릅니다. 대표번호는 ARS 를 거치지만 전용번호는 담당 부서로 바로 연결되기 때문입니다. 2026-08-27 기준 공식 안내에 올라와 있는 번호는 아래 2개입니다.',
      highlights: ['1599-7942', '대표번호', '전용번호'],
      table: {
        headers: ['구분', '번호', '비고'],
    ...
    },
    {
      ...
      intro:
        '하나캐피탈 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 평일 09:00~18:00에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '하나캐피탈은 공식 안내에 지점 주소를 따로 걸어두지 않습니다. 가시기 전에 문 여는 시간을 같이 보세요.',
        label: '지도에서 위치 보기',
        url: MAP,
      },
      sourceNote: '* 출처: 하나캐피탈 사업자 정보 (2026-08-27 확인)',
    },
    {
      ...
      act: {
        cue: '하나캐피탈 상담은 평일 09:00~18:00 안에서만 됩니다. 어디가 지금 받는지는 목록에서 바로 갈립니다.',
        label: '대출 고객센터 목록',
        url: HUB,
      },
  ...
  faqData: [
    ...
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: '하나캐피탈 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 한도 조회나 서류 제출은 방문하지 않아도 전화·앱으로 처리되는 경우입니다.',
      source: '하나캐피탈 사업자 정보',
      sourceUrl: 'https://www.hanacapital.co.kr',
    },
  ],
