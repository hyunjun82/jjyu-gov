...
export const samsungLifeLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 (평일 09:00 ~ 18:00)이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
