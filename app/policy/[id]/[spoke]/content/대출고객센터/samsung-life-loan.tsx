...
/* 추출본: scripts/output/source-samsung-life-loan-call-center.txt
 * 1차 출처: 삼성생명 상담 안내 (https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView)
 * 확인일: 2026-08-27
 *
 * 이 파일은 scripts/new-call-center.ts 가 samsung-life-loan.json 로 찍어낸다.
...
export const samsungLifeLoanCallCenterSpokeContent: SpokeData = {
  h1: '삼성생명 대출 고객센터 전화번호 및 대출 상담 연결 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '삼성생명 대출 고객센터',
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 (평일 09:00 ~ 18:00)이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '삼성생명 고객센터 전화번호 1588-3114. 상담시간 대표 콜센터 (평일 09:00 ~ 18:00), 상담원 연결은 이 시간 안에서만 됩니다. 대출 업무별 번호 2개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  dateModified: '2026-08-27T09:00:00+09:00',

  heroHook:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 (평일 09:00 ~ 18:00)이며 이 시간을 벗어나면 상담원 연결이 안 됩니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·부가 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  heroAct: { label: '1588-3114 바로 통화', href: TEL },

  keyFacts: {
    '대표번호': '1588-3114 (대표 콜센터 (보험계약·대출))',
  ...
  qa: [
    {
      ...
      intro:
        '대표번호는 1588-3114입니다. 대출 상담, 만기연장, 중도상환, 금리 문의까지 이 번호 하나로 들어갑니다. 다만 용건이 정해져 있으면 전용번호로 거는 편이 빠릅니다. 대표번호는 ARS 를 거치지만 전용번호는 담당 부서로 바로 연결되기 때문입니다. 2026-08-27 기준 공식 안내에 올라와 있는 번호는 아래 2개입니다.',
      highlights: ['1588-3114', '대표번호', '전용번호'],
      table: {
        headers: ['구분', '번호', '비고'],
        rows: [['대표 콜센터 (보험계약·대출)', '1588-3114', '원문 업무 목록에 "대출" 이 적혀 있다'], ['무료 전화', '080-789-3300', '통화료 무료']],
      },
      sourceNote: '* 출처: 삼성생명 상담 안내 (2026-08-27 확인)',
    },
    {
      q: '상담원과 바로 연결하려면 몇 번 누르나요?', anchor: 'q2',
      intro:
        '삼성생명 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 다만 이건 대표 콜센터 (평일 09:00 ~ 18:00)에만 됩니다. 그 시간을 벗어나면 상담원 연결 항목 자체가 없고 접수·조회 같은 접수 기능만 돌아갑니다. 아래는 시간대별로 번호가 어떻게 갈리는지 정리한 것입니다.',
      highlights: ['상담원 연결', '대표 콜센터 (평일 09:00 ~ 18:00)'],
      table: {
    ...
    },
    {
      ...
      intro:
        '상담원 상담은 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 공식 안내 기준으로 이 시간을 벗어나면 상담원 연결이 안 됩니다. 야간·공휴일 운영 표기가 따로 없으니, 급한 용건도 대표 콜센터 (평일 09:00 ~ 18:00) 안에 거셔야 합니다.',
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '삼성생명은 공식 안내에 지점 주소를 따로 걸어두지 않습니다. 헛걸음하지 않게 위치부터 짚고 나서시죠.',
        label: '지도에서 위치 보기',
        url: MAP,
      },
      sourceNote: '* 출처: 삼성생명 사업자 정보 (2026-08-27 확인)',
    },
    {
      ...
      act: {
        cue: '삼성생명 상담은 대표 콜센터 (평일 09:00 ~ 18:00) 안에서만 됩니다. 급할 때 다시 찾지 않게 목록을 열어 두시죠.',
        label: '대출 고객센터 목록',
        url: HUB,
      },
  ...
  faqData: [
    {
      ...
      a: '대표번호는 1588-3114입니다. (2026-08-27 확인 기준)',
      source: '삼성생명 상담 안내',
    ...
    },
    {
      ...
      a: '공식 안내에 ARS 단축번호가 나와 있지 않습니다. 안내 음성에 따라 상담원 연결 항목을 고르세요. 대표 콜센터 (평일 09:00 ~ 18:00)에만 가능합니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
      q: '주말이나 공휴일에도 상담이 되나요?',
      a: '상담원 상담은 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 공식 안내에 야간·공휴일 운영 표기가 없어, 이 시간을 벗어나면 연결되지 않습니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
    ...
    {
      q: '점심시간에도 상담이 되나요?',
      a: '삼성생명 공식 고객센터 안내에는 점심시간 휴무 표기가 없습니다. 상담 가능 시간은 대표 콜센터 (평일 09:00 ~ 18:00)으로 안내되어 있고, 그 시간 안에서는 점심시간이라고 따로 끊긴다는 안내가 없습니다. 다만 상담원 수가 줄어 대기가 길어질 수는 있으니, 급하지 않다면 오전 이른 시간에 거는 편이 낫습니다.',
      source: '삼성생명 상담 안내',
      sourceUrl: 'https://direct.samsunglife.com/customerSupport/inquiryGuide/CustomerSupportInquiryGuideMainView',
    },
    {
    ...
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: '삼성생명 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 한도 조회나 서류 제출은 방문하지 않아도 전화·앱으로 처리되는 경우입니다.',
      source: '삼성생명 사업자 정보',
  ...
  callCenter: {
    ...
    "offhourNote": "공식 안내 기준으로 대표 콜센터 (평일 09:00 ~ 18:00)을 벗어나면 상담원 연결이 안 됩니다. 대출 상담은 영업시간 안에 거는 편이 빠릅니다.",
    "word": "금융사",
    "hubWord": "대출 고객센터",
    "agentWord": "상담원",
    "offhourWord": "접수·조회",
