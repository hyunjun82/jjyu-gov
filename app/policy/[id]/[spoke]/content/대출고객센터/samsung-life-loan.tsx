...
export const samsungLifeLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    '삼성생명 고객센터 대표번호는 1588-3114, 상담 운영시간은 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '삼성생명 고객센터 전화번호 1588-3114. 상담시간 대표 콜센터 (평일 09:00 ~ 18:00). 대출 업무별 번호 2개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '삼성생명 공식 안내에는 상담원에게 바로 넘어가는 단축번호가 공개돼 있지 않습니다. 공식 안내에 적힌 상담원 상담시간은 대표 콜센터 (평일 09:00 ~ 18:00)입니다.',
    ...
    },
    {
      ...
      intro:
        '상담원 상담은 공식 안내 기준 대표 콜센터 (평일 09:00 ~ 18:00)입니다.',
      highlights: ['대표 콜센터 (평일 09:00 ~ 18:00)'],
      table: {
        headers: ['번호', '야간·휴일'],
        rows: [],
      },
    ...
    },
    {
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '삼성생명 창구 위치는 지도 검색이 가장 빠릅니다. 헛걸음하지 않게 위치부터 짚고 나서시죠.',
        label: '지도에서 위치 보기',
        url: MAP,
      },
    ...
    },
    {
      ...
      act: {
        cue: '삼성생명 상담시간은 공식 안내 기준 대표 콜센터 (평일 09:00 ~ 18:00)입니다. 급할 때 다시 찾지 않게 목록을 열어 두시죠.',
        label: '대출 고객센터 목록',
        url: HUB,
      },
  ...
  callCenter: {
    ...
    "offhourNote": "공식 안내에 적힌 상담시간은 대표 콜센터 (평일 09:00 ~ 18:00)입니다.",
    "word": "금융사",
    "hubWord": "대출 고객센터",
    "agentWord": "상담원",
    "offhourWord": "접수·조회",
