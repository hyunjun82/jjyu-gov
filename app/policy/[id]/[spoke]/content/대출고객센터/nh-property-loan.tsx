...
export const nhPropertyLoanCallCenterSpokeContent: SpokeData = {
  ...
  description:
    'NH농협손해보험 고객센터 대표번호는 1644-9000, 상담 운영시간은 09:00 ~ 18:00이며 야간·공휴일 운영은 공식 안내에 따로 적혀 있습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 대출 상담 연결 순서·업무별 번호·고객센터 위치도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    'NH농협손해보험 고객센터 전화번호 1644-9000. 상담원 연결은 ARS 0번. 상담시간 상담사 연결(평일) 09:00 ~ 18:00, 야간·공휴일 운영은 공식 안내 표기 기준. 대출 업무별 번호 3개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
