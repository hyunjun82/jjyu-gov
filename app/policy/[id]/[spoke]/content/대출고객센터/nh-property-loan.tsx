...
export const nhPropertyLoanCallCenterSpokeContent: SpokeData = {
  h1: 'NH농협손해보험 대출 고객센터 전화번호·상담 연결·영업시간, 대표번호로 될까?',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: 'NH농협손해보험 대출 고객센터',
  description:
    'NH농협손해보험 고객센터 대표번호는 1644-9000, 상담 운영시간은 09:00 ~ 18:00이며 접수·조회는 야간·공휴일에도 접수됩니다. 번호를 외우실 필요는 없습니다. 아래 버튼으로 걸고, 단축번호는 화면을 보면서 누르시면 됩니다.',
