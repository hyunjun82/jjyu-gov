...
export const 배우자출산휴가급여회사지급정부지원구분SpokeContent: SpokeData = {
  ...
  description:
    '배우자 출산휴가급여: 우선지원대상기업(정부 전액·20일 기준 168만원 상한) vs 대규모기업(사업주 부담). 제조업 500인·건설 300인·서비스 100인 이하 우선지원대상. 고용24(work24.go.kr) 신청.',
  datePublished: '2026-05-20T09:00:00+09:00',
  dateModified: '2026-05-23T09:00:00+09:00',
  keyFacts: {
    '우선지원대상기업': '고용보험(정부) 전액 지원, 20일 기준 168만원 상한',
    '대규모기업': '사업주(회사) 전액 부담',
    '제조업 기준': '상시 500인 이하',
    '서비스업 기준': '상시 100인 이하',
  ...
  qa: [
    {
      ...
      anchor: 'who-pays',
      intro:
        '근로자가 근무하는 기업의 규모에 따라 달라집니다. 우선지원대상기업(중소기업) 근로자는 고용보험(정부)에서 급여를 전액 지원받습니다. 대규모기업 근로자는 사업주(회사)가 급여를 부담합니다. 두 경우 모두 통상임금 100% 유급이며, 우선지원대상기업 정부 지원 상한은 20일 기준 168만원입니다.',
      highlights: ['우선지원대상기업: 정부 지원', '대규모기업: 사업주 부담'],
      table: {
        headers: ['항목', '우선지원대상기업', '대규모기업'],
        rows: [
          ['급여 지급 주체', '고용보험(정부)', '사업주(회사)'],
          ['지급 상한', '20일 기준 168만원', '통상임금 100%'],
