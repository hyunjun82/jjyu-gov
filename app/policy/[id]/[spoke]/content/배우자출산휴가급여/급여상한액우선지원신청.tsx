...
export const 배우자출산휴가급여급여상한액우선지원신청SpokeContent: SpokeData = {
  ...
  description:
    '배우자 출산휴가급여 상한액 20일 기준 168만원. 통상임금 100% 지급. 우선지원대상기업 고용보험 지원, 피보험 180일 이상 필수. 고용24(work24.go.kr) 온라인 신청, 휴가 종료 후 12개월 이내.',
  datePublished: '2026-05-20T09:00:00+09:00',
  dateModified: '2026-05-23T09:00:00+09:00',
  keyFacts: {
    '급여 기준': '통상임금 100%',
    '상한액': '20일 기준 168만원 (정부 지원 한도)',
    '지원 대상': '우선지원대상기업 근로자',
  ...
  qa: [
    {
      ...
      anchor: 'limit',
      intro:
        '배우자 출산휴가급여의 상한액은 20일 기준 168만원입니다. 통상임금 100%가 지급되며, 상한액은 정부 지원의 최대 한도입니다. 통상임금이 168만원보다 낮은 경우 통상임금 전액이 지급됩니다. 상한액 초과분은 우선지원대상기업의 경우 정부에서 지원하지 않으며, 사업주가 추가 지급할 수 있습니다. 우선지원대상기업이 아닌 대규모기업은 사업주가 전액 부담합니다.',
      highlights: ['20일 기준 168만원', '통상임금 100%', '상한액 초과분은 정부 미지원'],
      table: {
        headers: ['항목', '기준'],
        rows: [
          ['지급 기준', '통상임금 100%'],
    ...
    },
    {
      ...
      anchor: 'below-limit',
      intro:
        '통상임금 전액을 받습니다. 상한액(20일 기준 168만원)은 최대 한도이므로, 통상임금이 이보다 낮으면 통상임금 전액이 지급됩니다. 예를 들어 통상임금이 월 120만원이라면 120만원 전액을 받게 됩니다. 상한액보다 높은 통상임금을 받는 경우, 168만원 한도까지만 정부가 지원하고 초과분은 우선지원대상기업이라도 정부 미지원입니다.',
      highlights: ['통상임금 전액 지급', '상한액은 최대 한도'],
      table: {
        headers: ['통상임금 수준', '받는 급여'],
        rows: [
          ['168만원 이하', '통상임금 전액'],
          ['168만원 초과', '20일 기준 168만원 (상한액 한도)'],
        ],
      },
    },
    {
