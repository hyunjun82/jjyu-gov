...
export const 배우자출산휴가급여배우자출산휴가급여20일유급기준SpokeContent: SpokeData = {
  ...
  description:
    '배우자 출산휴가 20일 전부 유급, 통상임금 100% 20일 기준 168만원. 우선지원대상기업 고용보험 전액 지원. 출산일 120일 이내 3회 분할. 고용24(work24.go.kr) 신청, 180일 이상 피보험 필수.',
  ...
  qa: [
    ...
    },
    {
      ...
      anchor: 'paid',
      intro:
        '네, 20일 전부가 유급입니다. 통상임금 100%가 지급되며, 우선지원대상기업 근로자는 고용보험(정부)에서 전액 지원됩니다. 상한액은 20일 기준 168만원이며, 통상임금이 이보다 낮으면 통상임금 전액을 받습니다. 대규모기업의 경우에도 사업주가 유급으로 처리해야 하며, 이를 이행하지 않으면 근로기준법 위반입니다.',
      highlights: ['20일 전부 유급', '통상임금 100%', '고용보험 전액 지원'],
      table: {
        headers: ['구분', '지급 주체', '상한액'],
        rows: [
          ['우선지원대상기업', '고용보험(정부) 전액 지원', '20일 기준 168만원'],
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '정부 지원 상한(20일 기준 168만원)을 초과하는 부분은 사업주가 지급할 의무가 없습니다.',
      source: '고용노동부',
