...
export const 재난적의료비중위소득100이하신청자격SpokeContent: SpokeData = {
  ...
  qa: [
    {
      ...
      anchor: 'eligibility',
      intro: '재난적의료비 지원은 기준 중위소득 100% 이하 가구가 기본 대상이며, 가구 재산이 7억원 이하여야 합니다. 소득 기준은 건강보험료 납부액을 기준으로 확인합니다. 입원의 경우 모든 질환이 해당되며, 외래는 암·뇌혈관·심장·희귀·중증난치·중증화상 6개 중증질환에 한합니다. 중위소득 100~200% 이하는 소득 대비 의료비 부담이 과중한 경우 개별 심사를 통해 탄력 지원을 받을 수 있습니다.',
      highlights: ['중위소득 100% 이하', '재산 7억원 이하', '6개 중증질환', '개별 심사'],
      table: {
    ...
    },
    {
      ...
      intro: '연간 지원 한도(질환 구분 없이 통합 5,000만원) 범위 내에서 여러 번 신청이 가능합니다. 단, 같은 해 이미 지원을 받았다면 잔여 한도 내에서 추가 지원이 이루어집니다. 한도가 소진된 경우 같은 해 추가 지원은 어렵습니다.',
      highlights: ['연간 최대 5,000만원', '통합 한도', '여러 번 신청 가능'],
      table: {
        headers: ['구분', '연간 한도'],
        rows: [
  ...
  faqData: [
    ...
    },
    {
      ...
      a: '연간 지원 한도(질환 구분 없이 통합 최대 5,000만원) 범위 내에서 여러 번 지원 신청이 가능합니다.',
      source: '보건복지부',
      sourceUrl: 'https://www.mohw.go.kr',
    },
  ],
