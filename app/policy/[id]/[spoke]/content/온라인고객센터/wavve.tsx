...
export const wavveCallCenterSpokeContent: SpokeData = {
  h1: '웨이브 고객센터 전화번호·상담원 연결·영업시간, 앱에 없으면?',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '웨이브 고객센터',
  description:
    '웨이브 고객센터 대표번호는 1599-3709입니다. 공식 안내에 상담 가능 시간이 따로 표기돼 있지 않습니다. 아래 버튼으로 바로 걸으실 수 있습니다.',
  ...
  faqData: [
    ...
    {
      q: '방문 상담은 어디로 가야 하나요?',
      a: '웨이브 지점·서비스망 위치는 수시로 바뀌어 이 글에 주소를 적어두지 않습니다. 공식 홈페이지의 지점 찾기나 지도에서 지역을 넣어 검색하면 현재 운영 중인 곳이 나옵니다. 환불이나 계정 복구는 방문하지 않아도 전화·앱으로 처리되는 경우입니다.',
      source: '웨이브 사업자 정보',
