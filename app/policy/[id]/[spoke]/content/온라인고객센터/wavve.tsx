...
export const wavveCallCenterSpokeContent: SpokeData = {
  ...
  breadcrumb: '웨이브 고객센터',
  description:
    '웨이브 고객센터 대표번호는 1599-3709입니다. 공식 안내에 상담 가능 시간이 따로 표기돼 있지 않습니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·문의 방법·업무별 번호도 함께 확인할 수 있습니다.',
  ...
  qa: [
    ...
    },
    {
      ...
      intro:
        '웨이브 공식 안내는 상담원 연결 항목을 번호와 함께 표기하지 않습니다. 안내 음성을 끝까지 듣고 상담원 연결 항목을 고르시면 됩니다. 상담원 연결이 되는 시간은 공식 안내에 적혀 있지 않습니다. 통화 전 홈페이지에서 한 번 확인하시는 편이 낫습니다.',
  ...
  faqData: [
    ...
    {
      q: '점심시간에도 상담이 되나요?',
      a: '웨이브 공식 안내에는 상담 가능 시간도, 점심시간 휴무도 적혀 있지 않습니다. 통화 전 공식 홈페이지에서 확인하시는 편이 확실합니다.',
      source: '와이즈유저 방송통신이용자정보포털 미디어 사업자 고객센터',
      sourceUrl: 'https://wiseuser.go.kr/square.do?boardno=6490&boardtypecode=5900',
    },
    {
