...
/* 추출본: scripts/output/source-afreecatv-call-center.txt
 * 1차 출처: 와이즈유저 방송통신이용자정보포털 미디어 사업자 고객센터 (https://wiseuser.go.kr/square.do?boardno=6490&boardtypecode=5900)
 * 확인일: 2026-08-27
 *
 * 이 파일은 scripts/new-call-center.ts 가 afreecatv.json 로 찍어낸다.
 * 손으로 고치지 말고 JSON 을 고친 뒤 다시 돌린다 — 손으로 쓰면 ARS 번호가 틀린다.
 *
 * 쓰지 않는 것: 공식 페이지에 없는 번호·시간. 생성기가 추출본과 대조해 막는다.
 */

const TEL = 'tel:16887022';
const OFFICIAL = 'https://wiseuser.go.kr';
const MAP = 'https://map.naver.com/p/search/%EC%95%84%ED%94%84%EB%A6%AC%EC%B9%B4TV';
const HUB = '/policy/online-call-center';

export const afreecatvCallCenterSpokeContent: SpokeData = {
  h1: '아프리카TV 고객센터 전화번호 및 상담원 연결·문의 안내',
  /* 업종어를 넣는다 — 대출 글인데 "웰컴저축은행 고객센터" 로 나가면
     회사 고객센터 글과 구분이 안 된다 (2026-08-27 사장님 확인). */
  breadcrumb: '아프리카TV 고객센터',
  description:
    '아프리카TV 고객센터 대표번호는 1688-7022입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·문의 방법·업무별 번호도 함께 확인할 수 있습니다.',
  ...
  metaDescription:
    '아프리카TV 고객센터 전화번호 1688-7022. 문의 유형별 번호 1개와 상담원 연결 방법까지 2026-08-27 공식 안내 기준.',
  dateModified: '2026-08-27T09:00:00+09:00',

  heroHook:
    '아프리카TV 고객센터 대표번호는 1688-7022입니다. 아래 대표번호 버튼을 누르면 바로 전화가 연결되고, 상담원 연결 순서·문의 방법·업무별 번호도 함께 확인할 수 있습니다.',
  heroAct: { label: '1688-7022 눌러서 걸기', href: TEL },
  ...
  qa: [
    {
      q: '아프리카TV 고객센터 전화번호 몇 번인가요?', anchor: 'q1',
      intro:
        '대표번호는 1688-7022입니다. 주문·결제 문의, 환불, 계정 문제까지 이 번호 하나로 들어갑니다. 다만 용건이 정해져 있으면 전용번호로 거는 편이 빠릅니다. 대표번호는 ARS 를 거치지만 전용번호는 담당 부서로 바로 연결되기 때문입니다. 2026-08-27 기준 공식 안내에 올라와 있는 번호는 아래 1개입니다.',
      highlights: ['1688-7022', '대표번호', '전용번호'],
      table: {
        headers: ['구분', '번호', '비고'],
        rows: [['고객센터', '1688-7022', '유료']],
      },
    ...
    },
    {
      ...
      intro:
        '아프리카TV 공식 안내에는 상담원에게 바로 넘어가는 단축번호가 공개돼 있지 않습니다.',
      highlights: ['상담원 연결'],
      table: {
        headers: ['번호', '평일 주간'],
        rows: [],
    ...
    },
    {
      ...
      intro:
        '아프리카TV 공식 고객센터 안내에는 상담시간이 따로 적혀 있지 않아, 이 글에도 시간을 적지 않았습니다.',
      highlights: [],
      table: {
        headers: ['번호', '야간·휴일'],
        rows: [],
    ...
    {
      q: '아프리카TV 고객센터 위치는 어디인가요?', anchor: 'q4',
      intro:
      ...
      highlights: ['가까운 지점'],
      act: {
        cue: '아프리카TV 창구 위치는 지도 검색이 가장 빠릅니다. 창구에서만 되는 일이 아니면 안 가셔도 됩니다.',
        label: '지점 위치 확인하기',
        url: MAP,
      },
      sourceNote: '* 출처: 아프리카TV 사업자 정보 (2026-08-27 확인)',
    },
    {
      ...
      act: {
        cue: '아프리카TV 대표번호는 1688-7022 하나입니다. 두 곳 넘게 쓰신다면 미리 챙겨 두는 게 낫습니다.',
        label: '다른 서비스 번호 보기',
        url: HUB,
      },
  ...
  faqData: [
    {
      q: '아프리카TV 고객센터 전화번호는 몇 번인가요?',
      a: '대표번호는 1688-7022입니다. (2026-08-27 확인 기준)',
  ...
  sources: [
    ...
    { name: '아프리카TV 공식 홈페이지', url: OFFICIAL },
  ],
